...
var FlowChart = class {
    ...
    set selectedPort(t) {
        if (this._.selectedPort != t) {
            ...
            !1 !==
                FlowChart.events.publish("selected-port-change", [
                    this._.chart,
                    e,
                ]) &&
                (null == t
                    ? ((this._.selectedPort = null),
                        this._.hidePortShapeBarUI())
    ...
    set scale(t) {
        if (this.scale != t) {
            ...
            var e = [50, 50],
                r = this.viewBox,
                i = this._.svgBCR.width,
                o = this._.svgBCR.height,
                a = i / r[2],
                s = o / r[3],
                h = a > s ? s : a,
                l = r,
            ...
            (r[2] = r[2] / (t / h)),
                (r[3] = r[3] / (t / h)),
                (r[0] = l[0] - (r[2] - n) / (100 / e[0])),
                (r[1] = l[1] - (r[3] - c) / (100 / e[1])),
                (this.viewBox = r);
        }
    }
    static MAGNET_MOVE_PIXELS = 10;
    static MAGNET_RESIZE_PIXELS = 7;
    static MAGNET_WIN_PIXELS = 20;
    ...
    static animate = function (t, e, r, i, o, a, s) {
        return FlowChart.private.animate(t, e, r, i, o, a, s);
    };
    constructor(t, e) {
    ...
    addNodeWithLink(t, e, r) {
        this._.addNodeWithLink(t, e, r);
    }
    load(t) {
        this._.load(t);
    }
    ...
    alignShapes(t, e, r) {
        this._.alignShapes(t, e, r);
    }
    reposition(t) {
        this._.reposition(t);
    }
    rippleShape(t, e, r) {
        FlowChart.private.rippleShape(t, e, r);
    }
    makeShapeVisible(t, e) {
        t && this._.makeShapesVisible([t], e);
    }
    onInit(t) {
        return this._.on("init", function (e, r) {
            return t.call(e, r);
        });
    }
    onChanged(t) {
        return this._.on("changed", function (e, r) {
            return t.call(e, r);
        });
    }
    onUndoRedoChanged(t) {
        return this._.on("undo-redo-changed", function (e, r) {
            return t.call(e, r);
        });
    }
    onSelectedShapesChanged(t) {
        return this._.on("selected-shapes-changed", function (e, r) {
            return t.call(e, r);
        });
    }
    onSelectedPortChange(t) {
        return this._.on("selected-port-change", function (e, r) {
            alert('ttt')
            return t.call(e, r);
        });
    }
    onShortcut(t) {
        return this._.on("shortcut", function (e, r) {
            return t.call(e, r);
        });
    }
    onMenuItemClick(t) {
        return this._.on("menu-item-click", function (e, r) {
            return t.call(e, r);
        });
    }
    onLinkPoints(t) {
        return this._.on("link-points", function (e, r) {
            return t.call(e, r);
        });
    }
    onShapeDoubleClick(t) {
        return this._.on("shape-db-click", function (e, r) {
            return t.call(e, r);
        });
    }
    onShapeClick(t) {
        return this._.on("shape-click", function (e, r) {
            return t.call(e, r);
        });
    }
    onSvgClick(t) {
        return this._.on("svg-click", function (e, r) {
            return t.call(e, r);
        });
    }
    onFieldChange(t) {
        return this._.on("field-change", function (e, r) {
            return t.call(e, r);
        });
    }
};
void 0 === FlowChart && (FlowChart = {}),
    (FlowChart.VERSION = "1.01.02"),
    ...
    (FlowChart.private = class {
        ...
        snap() {
            this.useChangeListener &&
                (this.changedTimeout ||
                    (this.putInUndoStack(), this.clearRedo()));
        }
        addNodeWithLink(t, e, r) {
            var i = this,
                o = { templateId: e };
            (o = this.chart.nodes.add(o)).element.style.opacity = 0;
            var a = this.chart.links.getByShape(t.shape),
                s = [];
            for (var h of a) {
                if (this.chart.ports.getByLink(h).fromPort == t)
                    (n = this.chart.nodes.get(h.to)) && s.push(n.id);
            }
            var l = [];
            for (var n of this.chart.nodes)
                l.push({ x: n.x, y: n.y, w: n.width, h: n.height, id: n.id, ApplicationId: 0 });
            FlowChart.private.devin(
                ...
                function (e) {
                    ...
                    for (var n of e) {
                        ...
                        h.push(d), (c.x = -1e4), (c.y = -1e4), a.push(c);
                    }
                    for (var u = 0; u < a.length; u++)
                        (a[u].x = s[u].x), (a[u].y = s[u].y);
                    i.animateShapes(a, s, h, function () {
                        r && r(o, w),
                            i.makeShapesVisible([a], function () {
                                var t = i.chart.editor.getFieldNames(o);
                                t.length && i.chart.editor.edit(o, t[0]);
                            });
                    });
                    var f = i.chart.ports.getByOpositeOfPosition(
                        o.id,
                        t.position
                    )[0],
                        w = {
        ...
        changed(t) {
            if (this.useChangeListener) {
                ...
                for (var r in t) {
                    var i = t[r];
                    (r = "property") &&
                        -1 == this.changedArgs.properties.indexOf(i) &&
                        this.changedArgs.properties.push(i);
                }
                if ("selectedShapes" == t.property)
                    for (var o of (FlowChart.events.publish(
                        "selected-shapes-changed",
                        [e.chart]
                    ),
                        this.chart.editor.clearFieldBorders(),
                        e.chart.selectedShapes))
                        this.chart.editor.edit(o);
                this.changedTimeout &&
                        ...
                        if (e.chart.options.useSession)
                            try {
                                ...
                                sessionStorage.clear(),
                                    sessionStorage.setItem("Form", t)
                            } catch (t) {
                                t.code == t.QUOTA_EXCEEDED_ERR &&
                                    sessionStorage.clear(),
                                    console.error(t);
                            }
                        FlowChart.events.publish("changed", [
                            e.chart,
                            e.changedArgs,
                        ]),
        ...
        load(t) {
            ...
            if (t) {
                if (
                    ...
                    for (var r of t.selectedShapes) {
                        var i = this.chart.getShape(r);
                        i && (i.selected = !0);
                    }
                t.viewBox &&
                    (this.setViewBox(t.viewBox), (this.initialized = !0));
            }
            this.initialized ||
            ...
            if (this.chart.options.useSession)
                try {
                    sessionStorage.setItem(`${this.uid}_state`, o);
                } catch (t) {
        ...
        generateId() {
            for (
                var t = this.chart.nodes.length + this.chart.labels.length;
                ;

            ) {
                if (
                    !this.chart.nodes.contains(t) &&
                    !this.chart.labels.contains(t)
                )
                    return t;
                t++;
            }
        ...
        getSizeOfHTML(t) {
            ...
            var e = this.chart.svgElement.querySelector(
                "[data-test-elastic-size]"
            );
            e.innerHTML = t;
            var r = e.getBoundingClientRect(),
                i = this.chart.scale;
            return { width: r.width / i + 6, height: r.height / i + 6 };
        }
        getActiveComponentTypes() {
            ...
            return (
                ...
                t.length
                    ? (t.push("shape"),
                        this.chart.selectedShapes.nodes.length ==
                        this.chart.nodes.length && t.push("all-nodes"),
                        t)
                    : "canvas"
            );
        }
        zoom(t, e) {
            var r = this.chart.viewBox,
                i = r,
                o = r[2],
                a = r[3];
            !0 === t
                ? ((r[2] = r[2] / FlowChart.SCALE_FACTOR),
                    (r[3] = r[3] / FlowChart.SCALE_FACTOR))
                : !1 === t
                    ? ((r[2] = r[2] * FlowChart.SCALE_FACTOR),
                        (r[3] = r[3] * FlowChart.SCALE_FACTOR))
                    : ((r[2] = r[2] / t), (r[3] = r[3] / t)),
                e || (e = [50, 50]),
                (r[0] = i[0] - (r[2] - o) / (100 / e[0])),
                (r[1] = i[1] - (r[3] - a) / (100 / e[1]));
            var s = FlowChart.private.getScale(
                r,
                this.svgBCR.width,
                this.svgBCR.height
            );
            (r[2] = this.svgBCR.width / s), (r[3] = this.svgBCR.height / s);
            var h = this.chart.options;
            ((!0 === t && s < h.scaleMax) ||
                (!1 === t && s > h.scaleMin) ||
                (0 != t && 1 != t && s < h.scaleMax && s > h.scaleMin)) &&
                (this.chart.viewBox = r);
        }
        updateMatchedShortcuts(t, e, r) {
            this.matchedShortcuts = [];
            var i = this.getActiveComponentTypes();
            for (var o in FlowChart.shortcuts)
                if (!this.matchedShortcuts.includes(o)) {
                    var a = !0,
                        s = !0,
                        h = !0,
                        l = FlowChart.shortcuts[o];
                    if (l.keysPressed)
                        for (var n = 0; n < l.keysPressed.length; n++) {
                            ...
                            if (l.activeComponentType) {
                                var w = l.activeComponentType.split("|");
                                for (var y of w) i.includes(y) && (f = !0);
                            } else f = !0;
                            if (!f) {
                                h = !1;
                                break;
                        ...
                        e && l.keyDown
                            ? l.keyDown != e && (a = !1)
                            : r && l.keyUp && l.keyUp != r && (a = !1);
                    if (l.mouseActions)
                        for (n = 0; n < l.mouseActions.length; n++)
                            if (
                                !this.mouseActions.includes(l.mouseActions[n])
                            ) {
                                s = !1;
                                break;
                            }
                    if (s && a && h) {
                        this.matchedShortcuts.includes(o) ||
                            this.matchedShortcuts.push(o);
                        var m = this.chart.selectedShapes,
                            g = this.chart.selectedShapes.nodes;
                        if ("move_selected_nodes_left" == o)
                            (this.chart.selectedPortShape = null),
                                this.chart.nodes._.move(g, FlowChart.move.left);
                        else if ("move_selected_nodes_right" == o)
                            (this.chart.selectedPortShape = null),
                                this.chart.nodes._.move(
                                    g,
                                    FlowChart.move.right
                                );
                        else if ("move_selected_nodes_up" == o)
                            (this.chart.selectedPortShape = null),
                                this.chart.nodes._.move(g, FlowChart.move.up);
                        else if ("move_selected_nodes_down" == o)
                            (this.chart.selectedPortShape = null),
                                this.chart.nodes._.move(g, FlowChart.move.down);
                        else if ("align_tofirst_selected_nodes_bottom" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.bottom,
                                    !0
                                );
                        else if ("align_tofirst_selected_nodes_top" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.top,
                        ...
                        else if ("align_tofirst_selected_nodes_left" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.left,
                                    !0
                                );
                        else if ("align_tofirst_selected_nodes_right" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                            ...
                            "align_tofirst_selected_nodes_horizontally" == o
                        )
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.horizontally,
                                    !0
                                );
                        else if ("align_tofirst_selected_nodes_vertically" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.vertically,
                                    !0
                                );
                        else if ("align_tolast_selected_nodes_bottom" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.bottom,
                        ...
                        else if ("align_tolast_selected_nodes_top" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.top,
                        ...
                        else if ("align_tolast_selected_nodes_left" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.left,
                        ...
                        else if ("align_tolast_selected_nodes_right" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.right,
                            ...
                            "align_tolast_selected_nodes_horizontally" == o
                        )
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                        ...
                        else if ("align_tolast_selected_nodes_vertically" == o)
                            t.preventDefault(),
                                this.chart.alignShapes(
                                    m,
                                    FlowChart.align.vertically,
                        ...
                        else if ("remove_selected_shapes" == o)
                            this.chart.nodes.removeRange(
                                this.chart.selectedShapes.nodes
                            ),
                                this.chart.labels.removeRange(
                                    this.chart.selectedShapes.labels
                                );
                        else if ("select_all_nodes" == o)
                            for (var v of (t.preventDefault(),
                                this.chart.nodes))
                                "label" != v.type &&
                                    this.chart.selectedShapes.add(v);
                        else if ("undo" == o)
                            this.chart._.undo(),
                                this.chart.menuBar._.simulateMouseClickOnKeydown(
                                    "undo"
                                );
                        else if ("redo" == o)
                            this.chart._.redo(),
                        ...
                        else if ("edit_next_field" == o)
                            t.preventDefault(),
                                this.chart.editor.selectNextField();
                        else if ("exit_edit_field" == o)
                            this.chart.editor.blur();
                        else if ("close_port_shape_bar" == o)
                            this.chart.selectedPort = null;
                        else if ("deleselect_shapes" == o)
                            this.chart.selectedShapes.clear();
                        else if ("edit_shape" == o) {
                            var C = this.chart.selectedShapes.last;
                            t.preventDefault(),
                                this.chart.editor.editFirstFieldIfAny(C);
                        } else if ("select_node_above" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeAbove(!0);
                        else if ("select_node_below" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeBelow(!0);
                        else if ("select_node_left" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeLeft(!0);
                        else if ("select_node_right" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeRight(!0);
                        else if ("select_nodes_above" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeAbove(!1);
                        else if ("select_nodes_below" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeBelow(!1);
                        else if ("select_nodes_left" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeLeft(!1);
                        else if ("select_nodes_right" == o)
                            t.preventDefault(),
                                this.chart.editor.blur(),
                                this.chart.selectedShapes.selectNodeRight(!1);
                        else if ("paint_node" == o) {
                            if (null != e) {
                                var N = parseInt(e) - 1;
                                this.changeFill(N),
                                    this.chart.menuBar._.simulateMouseClickOnKeydown(
        ...
        changeFill(t) {
            ...
            for (
                var r = "", i = 0;
                i < this.changeFillPressedIndexes.length;
                i++
            )
                r += this.changeFillPressedIndexes[i].toString();
            t = parseInt(r) - 1;
            for (var o = this.chart.options.colors[t]; !o && r.length;)
                (r = r.substring(1)),
                    (t = parseInt(r) - 1),
                    (o = this.chart.options.colors[t]);
            if (o)
                for (var a of this.chart.selectedShapes)
                    a.fill != o && (a.fill = o);
        }
    }),
    void 0 === FlowChart && (FlowChart = {}),
    ...
    (FlowChart.private.animate = function (t, e, r, i, o, a, s) {
        var h,
            l = 10,
            n = 1,
            c = i / l + 1;
        ...
        return (
            ...
            (h = setInterval(function () {
                ...
                s && s(), (n += 1) > c + 1 && (clearInterval(h), a && a(t));
            }, l))
        );
    }),
    (FlowChart.private.linkFromTo = function (t, e, r, i, o) {
        var a = [];
        if (
            ...
            if (
                ...
                a.push({ x: r.x, y: r.y }),
                    ...
                    a.push({ x: e.left - FlowChart.LINK_DITSNANCE, y: h }),
                    a.push({ x: e.left - FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else if (
                ...
                a.push({ x: r.x, y: r.y }),
                    ...
                    a.push({ x: e.left - FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else a.push({ x: r.x, y: r.y }), a.push({ x: i.x, y: i.y });
        else if (
            ...
            if (
                ...
                h = e.top + e.height + (t.top - (e.top + e.height)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: t.left - FlowChart.LINK_DITSNANCE, y: r.y }),
                    a.push({ x: t.left - FlowChart.LINK_DITSNANCE, y: h }),
                    a.push({
            ...
            if (
                ...
                a.push({ x: r.x, y: r.y }),
                    ...
                    a.push({ x: s, y: e.top - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: e.top - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: i.y });
            } else if (
                t.left - FlowChart.LINK_DITSNANCE >
                e.left + e.width + FlowChart.LINK_DITSNANCE
            ...
            if (
                ...
                s = t.left + t.width + (e.left - (t.left + t.width)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: t.top - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: s, y: t.top - FlowChart.LINK_DITSNANCE }),
                    a.push({
                        x: s,
            ...
            if (
                ...
                a.push({ x: r.x, y: r.y }), a.push({ x: i.x, y: i.y });
            else if (
                r.y + FlowChart.LINK_DITSNANCE < i.y &&
                r.x < e.left - FlowChart.LINK_DITSNANCE
            )
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: i.y }),
                    a.push({ x: i.x, y: i.y });
                ...
                (n = Math.max(t.top + t.height, e.top + e.height)),
                    (c = Math.min(t.left, e.left));
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: n + FlowChart.LINK_DITSNANCE }),
                    a.push({
                        x: c - FlowChart.LINK_DITSNANCE,
                        y: n + FlowChart.LINK_DITSNANCE,
                    }),
                    a.push({ x: c - FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else if (t.top + t.height + FlowChart.LINK_DITSNANCE > e.top) {
                s = t.left + t.width + (e.left - (t.left + t.width)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({
                        x: r.x,
            ...
            if (
                ...
                r.y < i.y &&
                r.x > e.left + e.width + FlowChart.LINK_DITSNANCE
            )
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: i.y }),
                    a.push({ x: i.x, y: i.y });
                ...
                a.push({ x: r.x, y: r.y }),
                    ...
                    a.push({ x: d + FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else if (t.top + t.height + FlowChart.LINK_DITSNANCE > e.top) {
                s = e.left + e.width + (t.left - (e.left + e.width)) / 2;
                a.push({ x: r.x, y: r.y }),
            ...
            if (
                ...
                a.push({ x: r.x, y: r.y }), a.push({ x: i.x, y: i.y });
            else if (r.y > i.y && r.x < e.left - FlowChart.LINK_DITSNANCE)
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            else if (
                ...
                (l = Math.min(t.top, e.top)), (c = Math.min(t.left, e.left));
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: l - FlowChart.LINK_DITSNANCE }),
                    a.push({
                        x: c - FlowChart.LINK_DITSNANCE,
                        y: l - FlowChart.LINK_DITSNANCE,
                    }),
                    a.push({ x: c - FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else if (t.top + FlowChart.LINK_DITSNANCE < e.top + e.height) {
                s = t.left + t.width + (e.left - (t.left + t.width)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: t.top - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: s, y: t.top - FlowChart.LINK_DITSNANCE }),
            ...
            if (i.x < r.x)
                if (
                    t.top - FlowChart.LINK_DITSNANCE > i.y ||
                    t.top + t.height + FlowChart.LINK_DITSNANCE < i.y
                )
                    a.push({ x: r.x, y: r.y }),
                        a.push({
                            x: t.left + t.width + FlowChart.LINK_DITSNANCE,
                ...
                e.top - FlowChart.LINK_DITSNANCE > r.y ||
                e.top + e.height + FlowChart.LINK_DITSNANCE < r.y
            ) {
                d = Math.max(t.left + t.width, e.left + e.width);
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: d + FlowChart.LINK_DITSNANCE, y: r.y }),
                    a.push({ x: d + FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else
            ...
            if (i.x > r.x)
                ...
                c = Math.min(t.left, e.left);
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: c - FlowChart.LINK_DITSNANCE, y: r.y }),
                    a.push({ x: c - FlowChart.LINK_DITSNANCE, y: i.y }),
                    a.push({ x: i.x, y: i.y });
            } else
            ...
            if (i.y < r.y)
                t.left - FlowChart.LINK_DITSNANCE > i.x ||
                    t.left + t.width + FlowChart.LINK_DITSNANCE < i.x
                    ? (a.push({ x: r.x, y: r.y }),
                        a.push({ x: r.x, y: e.top - FlowChart.LINK_DITSNANCE }),
                        a.push({ x: i.x, y: e.top - FlowChart.LINK_DITSNANCE }),
                        a.push({ x: i.x, y: i.y }))
                    : e.top + e.height + FlowChart.LINK_DITSNANCE <
                        t.top - FlowChart.LINK_DITSNANCE
                ...
                e.left - FlowChart.LINK_DITSNANCE > r.x ||
                e.left + e.width + FlowChart.LINK_DITSNANCE < r.x
            ) {
                l = Math.min(t.top, e.top);
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: r.x, y: l - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: l - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: i.y });
            } else
                ...
                ? t.left - FlowChart.LINK_DITSNANCE > i.x ||
                    ...
                    : e.top + e.height + FlowChart.LINK_DITSNANCE <
                        ...
                        ? (a.push({ x: r.x, y: r.y }),
                            ...
                            a.push({ x: i.x, y: t.top - FlowChart.LINK_DITSNANCE }),
                            a.push({ x: i.x, y: i.y }))
                        : (a.push({ x: r.x, y: r.y }), a.push({ x: i.x, y: i.y }))
                : e.left - FlowChart.LINK_DITSNANCE > r.x ||
                    e.left + e.width + FlowChart.LINK_DITSNANCE < r.x
            ...
            if (
                ...
                i.x < t.left - FlowChart.LINK_DITSNANCE
            )
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: i.x, y: r.y }),
                    a.push({ x: i.x, y: i.y });
                ...
                a.push({ x: r.x, y: r.y }),
                    ...
                    a.push({ x: i.x, y: n + FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: i.y });
            } else if (e.top + e.height + FlowChart.LINK_DITSNANCE > t.top) {
                s = e.left + e.width + (t.left - (e.left + e.width)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: s, y: r.y }),
                    a.push({
            ...
            if (
                ...
                a.push({ x: r.x, y: r.y }), a.push({ x: i.x, y: i.y });
            else if (i.y > r.y && i.x < t.left - FlowChart.LINK_DITSNANCE)
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: i.x, y: r.y }),
                    a.push({ x: i.x, y: i.y });
            else if (
                ...
                (l = Math.min(e.top, t.top)), (c = Math.min(e.left, t.left));
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: c - FlowChart.LINK_DITSNANCE, y: r.y }),
                    a.push({
                        x: c - FlowChart.LINK_DITSNANCE,
                    ...
                    a.push({ x: i.x, y: l - FlowChart.LINK_DITSNANCE }),
                    a.push({ x: i.x, y: i.y });
            } else if (e.top + FlowChart.LINK_DITSNANCE < t.top + t.height) {
                s = e.left + e.width + (t.left - (e.left + e.width)) / 2;
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: s, y: r.y }),
                    a.push({ x: s, y: e.top - FlowChart.LINK_DITSNANCE }),
            ...
            if (
                ...
                i.y < r.y &&
                i.x > t.left + t.width + FlowChart.LINK_DITSNANCE
            )
                a.push({ x: r.x, y: r.y }),
                    a.push({ x: i.x, y: r.y }),
                    a.push({ x: i.x, y: i.y });
        ...
        var p = { points: a, fromShape: t, toShape: e, fromPort: r, toPort: i };
        return FlowChart.events.publish("link-points", [o, p]), p.points;
    }),
    (FlowChart.private.prototype.handlerKeyup = function (t) {
        var e = FlowChart.private.replaceRightLeftKeyCodes(t.code),
            r = t.key.toLowerCase(),
            i = this.keysPressed.indexOf(e);
        -1 != i &&
            (this.keysPressed.splice(i, 1),
                this.updateMatchedShortcuts(t, void 0, r)),
    ...
    (FlowChart.private.prototype.handlerKeydown = function (t) {
        ...
        "shift" == e &&
            (this.chart.selectedShapes._.arrayBeforeShiftPressed = this.chart.selectedShapes.slice());
        var r = FlowChart.private.replaceRightLeftKeyCodes(t.code);
        if (
            (this.keysPressed.includes(r) ||
                (this.keysPressed.push(r),
                    this.updateMatchedShortcuts(t, e, void 0)),
                t.target.hasAttribute("data-field"))
        ) {
            for (
                var i = t.target;
                i && i.hasAttribute && !i.hasAttribute("data-shape-id");

            )
                i = i.parentNode;
            if (i) {
                var o = i.getAttribute("data-shape-id");
                if (this.chart.selectedShapes.contains(o)) {
                    if (13 == t.keyCode) {
                        t.preventDefault();
                        ...
                        r.deleteContents(),
                            r.insertNode(i),
                            "BR" === a
                                ? (r.setStartAfter(i), r.setEndAfter(i))
                                : (r.setStart(i, 0), r.setEnd(i, 0));
    ...
    (FlowChart.private.prototype.handlerInput = function (t) {
        if (this.chart.editor.hasActiveField()) {
            for (var e = t.target; !e.hasAttribute("data-shape-id");)
                e = e.parentNode;
            var r = e.getAttribute("data-shape-id"),
                i = this.chart.getShape(r);
            if (
                (this.chart.editor.edit(i),
                    i.canWidthFitContent || i.canHeightFitContent)
            ) {
                for (
                    var o = t.target;
                    !o.hasAttribute || !o.hasAttribute("data-html-container");

                )
                    o = o.parentNode;
                var a = this.chart._.getSizeOfHTML(o.innerHTML);
                i.canWidthFitContent &&
                    ("label" == i.type
                        ? this.chart.labels._.setWidth(i, a.width)
                        : this.chart.nodes._.setWidth(i, a.width)),
                    i.canHeightFitContent &&
                    ("label" == i.type
                        ? this.chart.labels._.setHeight(i, a.height)
                        : this.chart.nodes._.setHeight(i, a.height));
            }
        }
    }),
    (FlowChart.private.prototype.handlerDblclick = function (t) {
        for (
            ...
            if (e.hasAttribute("data-link-id")) {
                var r = e.getAttribute("data-link-id"),
                    i = this.chart.links.getById(r),
                    o = FlowChart.private.getFirstPointIndexByMousePosition(
                        t,
                        this.chart.svgElement,
                        i
                    );
                FlowChart.direction.horizontal;
                i.points[o].x == i.points[o + 1].x &&
                    FlowChart.direction.vertical;
                for (var a = 0, s = 0; s < o; s++) {
                    var h = i.points[s],
                        l = i.points[s + 1];
                    a += Math.hypot(l.x - h.x, l.y - h.y);
                }
    ...
    (FlowChart.private.prototype.handlerMousemove = function (t) {
        for (var e = t.target, r = null, i = null; e && e != this.element;) {
            if (e && e.hasAttribute) {
                if (e.hasAttribute("data-link-id")) {
                    (r = this.chart.links.getById(
                        e.getAttribute("data-link-id")
                    )),
                        (i = "link");
                    break;
                }
                if (e.hasAttribute("data-shape-id")) {
                    (r = this.chart.getShape(e.getAttribute("data-shape-id"))),
                        (i = "node");
                    break;
                }
                if (e.hasAttribute("data-selector-shape-id")) {
                    (r = this.chart.getShape(
                        e.getAttribute("data-selector-shape-id")
                    )),
                        (i = "node");
                    break;
                }
                if (e.hasAttribute("data-ports-s-id")) {
                    (r = this.chart.nodes.get(
                        e.getAttribute("data-ports-s-id")
                    )),
                        (i = "node");
                    break;
                }
                if (e.hasAttribute("data-port-out-port")) {
                    var o = e.getAttribute("data-port-out-port"),
                        a = e.getAttribute("data-port-out-shape");
                    (r = this.chart.ports.get(a, o)), (i = "port");
                    break;
                }
                if (e.hasAttribute("data-portsb-shape")) {
                    (r = e.getAttribute("data-portsb-shape")),
                        (i = "portshapebart");
                    break;
                }
            }
        ...
        null != this.mouseOverShapeType && null == r
            ? ("node" == this.mouseOverShapeType
                ...
                (this.mouseOverShape = null),
                (this.mouseOverShapeType = null))
            : JSON.stringify(this.mouseOverShape) !== JSON.stringify(r) &&
            (null != r
                ? "node" == i
                    ? ("port" == this.mouseOverShapeType
                        ? this.handlerMouseleaveOnMiniShapeBar()
                        ...
                        ("portshapebart" == this.mouseOverShapeType &&
                            this.handlerMouseleaveOnMiniShapeBar()),
                        this.handlerMouseenterOnShape(t, r))
                    : "port" == i
                        ? ("node" == this.mouseOverShapeType ||
                            "link" == this.mouseOverShapeType ||
                            this.mouseOverShapeType,
                            this.handlerMouseenterOnPortOut(t, r))
                        : "link" == i
                            ? ("port" == this.mouseOverShapeType ||
                                "node" == this.mouseOverShapeType ||
                                this.mouseOverShapeType,
                                this.handlerMouseenterOnLink(t, r))
                            : "portshapebart" == i &&
                            ("port" == this.mouseOverShapeType ||
                                "node" == this.mouseOverShapeType ||
                                this.mouseOverShapeType)
                : this.mouseOverShape,
                (this.mouseOverShape = r),
                (this.mouseOverShapeType = i));
    }),
    (FlowChart.private.prototype.handlerTouchstartMousedown = function (
        t,
        e,
        r
    ) {
        for (var i = e.target; i && i != this.chart.element;) {
            if (
                i &&
                i.classList &&
                i.classList.contains &&
                i.classList.contains("bfc-shapebar-move")
            )
                return void this.handlerTouchstartMousedownOnShapeBarMove(
                    t,
                    e,
                    r,
                    i
                );
            if (i && i.hasAttribute && i.hasAttribute("data-selector-dot-2"))
                return void this.handlerTouchstartMousedownOnResizeDot(
                    t,
                    e,
                    r,
                    i
                );
            if (i && i.hasAttribute && i.hasAttribute("data-shapebar-item-id"))
                return void this.handlerDownOnShapeBarItem(e, r, i);
            if (i && i.hasAttribute && i.hasAttribute("data-shape-id")) {
                var o = this.chart.getShape(i.getAttribute("data-shape-id"));
                return void this.handlerTouchstartMousedownOnShape(e, r, o, !0);
            }
            if (i && i.hasAttribute && i.hasAttribute("data-link-id")) {
                var a = i.getAttribute("data-link-id");
                return void this.handlerTouchstartMousedownOnLink(e, r, a);
            }
            if (i && i.hasAttribute && i.hasAttribute("data-port-out-port"))
                return void this.handlerTouchstartMousedownOnPortOut(e, i, r);
            i == this.chart.svgElement &&
                this.handlerTouchstartMousedownOnSvg(t, e, r, i),
                (i = i.parentNode);
        }
    }),
    (FlowChart.private.prototype.handlerTouchendClick = function (t) {
        var e,
            r = t.target;
        if (
            (r.hasAttribute("data-field-selector") &&
                (e = r.getAttribute("data-field-selector")),
                this.chart.svgElement != r)
        )
            for (; r && r.hasAttribute;) {
                if (r.hasAttribute("data-shape-id")) {
                    var i = r.getAttribute("data-shape-id");
                    if (e) {
                        var o = this.chart.getShape(i);
                        this.chart.editor.edit(o, e);
                    } else {
                        n = { event: t, shapeId: i };
                        FlowChart.events.publish("shape-click", [
                            this.chart,
                            n,
                        ]),
                            this.handlerShapeClick(i, t);
                    }
                    return;
                }
                if (r.hasAttribute("data-menu-item")) {
                    var a = r.getAttribute("data-menu-item");
                    return void this.chart.menuBar._.handlerClick(t, a, r);
                }
                if (r.hasAttribute("data-portshapebar-item-id")) {
                    for (
                        var s = r.getAttribute("data-portshapebar-item-id");
                        !r.hasAttribute("data-portsb-shape");

                    )
                        r = r.parentNode;
                    i = r.getAttribute("data-portsb-shape");
                    var h = r.getAttribute("data-portsb-port"),
                        l = this.chart.ports.get(i, h);
    ...
    (FlowChart.private.prototype.handlerMouseenterOnLink = function (t, e) {
        var r = e,
            i = FlowChart.private.getFirstPointIndexByMousePosition(
                t,
                this.chart.svgElement,
                r
            ),
            o = FlowChart.direction.horizontal;
        r.points[i].x == r.points[i + 1].x &&
            (o = FlowChart.direction.vertical),
        ...
        show(t, e, r, i) {
            ...
            for (var s in i) {
                ...
                void 0 === h &&
                    ...
                    (a += `<div data-item="${s}">${h}<span>&nbsp;&nbsp;${l}</span></div>`);
            }
            if ("" != a) {
                if (
                ...
                for (
                    ...
                    (s = p[u]).addEventListener("click", function (t) {
                        var e,
                            a = this.getAttribute("data-item");
                        void 0 === i[a].onClick ||
                            (e = i[a].onClick.call(o._.chart, {
                                item: a,
                                nodeId: r,
                            })),
                            0 != e && o.hide();
    ...
    (FlowChart.private.prototype.handlerDownOnShapeBarItem = function (
        t,
        e,
        r
    ) {
        var i = this;
        this.chart.selectedShapes.clear();
        var o = r.getAttribute("data-shapebar-item-id"),
            a = this.chart.element
                .querySelector(`[data-shapebar-item-id="${o}"]`)
                .querySelector("svg"),
            s = a.getBoundingClientRect(),
            h = i.chart.shapeBar.element.getBoundingClientRect(),
            ...
            d = function (u) {
                ...
                if (
                    ...
                    !(function (t) {
                        var e = i.chart.element.querySelector(
                            ".bfc-drag-inside-shapes-palette"
                        ),
                            r = i.chart.svgElement.querySelector(
                                '[data-shape-id="drag-inside-canvas"]'
                            );
                        e ||
                            (((e = a.cloneNode(!0)).style.position =
                                "absolute"),
                                (e.style.top = s.y + "px"),
                                (e.style.left = s.x + "px"),
                                ...
                                i.chart.element.appendChild(e)),
                            (e.style.top = s.y + (t.y - l.y) + "px"),
                            (e.style.left = s.x + (t.x - l.x) + "px"),
                            r && r.parentNode.removeChild(r);
                    })(f);
                else {
                    var w = i.chart.svgElement.createSVGPoint();
                    (w.x = f.x),
                        (w.y = f.y),
                        (function (a) {
                            var s = i.chart.element.querySelector(
                                ".bfc-drag-inside-shapes-palette"
                            );
                            if (
                                !i.chart.svgElement.querySelector(
                                    '[data-shape-id="drag-inside-canvas"]'
                                )
                            ) {
                                var h = { templateId: o, x: a.x, y: a.y, ApplicationId: ApplicationId },
                                    ...
                                    w = u / n,
                                    y = f / c;
                                isNaN(w) && (w = r.offsetWidth / 2),
                                    isNaN(y) && (y = r.offsetHeight / 2),
                                    (h.x -= w - u / 2),
                                    (h.y -= y - f / 2),
                                    i.chart.nodes.add(h),
                                    (h = i.chart.nodes.get(h.id)),
                                    i.chart.element.removeEventListener(
                                        e.move,
                                        d
                                    ),
                                    i.chart.element.removeEventListener(
                                    ...
                                    i.handlerTouchstartMousedownOnShape(
                                        t,
                                        e,
                                        h
                                    );
                            ...
                            w.matrixTransform(
                                i.chart.svgElement.getScreenCTM().inverse()
                            )
                        );
                }
            },
            p = function (t) {
                var r = i.chart.element.querySelector(
                    ".bfc-drag-inside-shapes-palette"
                );
                r && r.parentNode.removeChild(r);
                var a = i.chart.svgElement.querySelector(
                    '[data-shape-id="drag-inside-canvas"]'
                );
                if (a) {
                    var s = FlowChart._getBox(a, i.nodes);
                    a.parentNode.removeChild(a),
                        i.addNode({ templateId: o, x: s.x1, y: s.y1 });
                }
                FlowChart.private.removeAlignmentLineElements(
                    i.chart.svgElement
                ),
                    i.chart.element.removeEventListener(e.move, d),
                    i.chart.element.removeEventListener(e.up, p),
                    e.leave && i.chart.element.removeEventListener(e.leave, p);
            };
    ...
    (FlowChart.private.prototype.handlerTouchstartMousedownOnLink = function (
        ...
        (this.chart.selectedPortShape = null),
            this.chart.selectedShapes.clear();
        var o = this.chart.links.getById(r),
            a = this.chart.scale,
            s = JSON.parse(JSON.stringify(o.points)),
        ...
        o.points[l].x == o.points[l + 1].x &&
            (n = FlowChart.direction.vertical);
        var c = function (t) {
            var e = FlowChart.private.getClientTouchesXY(t, 0);
            n == FlowChart.direction.horizontal
                ? ((o.points[l].y = (e.y - h.y + s[l].y * a) / a),
                    (o.points[l + 1].y = (e.y - h.y + s[l + 1].y * a) / a))
                : n == FlowChart.direction.vertical &&
                ((o.points[l].x = (e.x - h.x + s[l].x * a) / a),
                    (o.points[l + 1].x = (e.x - h.x + s[l + 1].x * a) / a));
        },
            d = function (t) {
                i.chart.element.removeEventListener(e.move, c),
                    i.chart.element.removeEventListener(e.up, d),
                    e.leave && i.chart.element.removeEventListener(e.leave, d);
            };
    ...
    (FlowChart.private.prototype.handlerTouchstartMousedownOnPortOut = function (
        ...
        var i = e.getAttribute("data-port-out-port"),
            o = e.getAttribute("data-port-out-shape"),
            a = FlowChart.private.getClientTouchesXY(t, 0),
        ...
        var h = {
            ...
            templateId: "psuedo",
            x: s.x,
            y: s.y, ApplicationId: ApplicationId
        };
        ...
        this.chart.links.add({
            ...
            this.handlerTouchstartMousedownOnShape(t, r, l, !0);
    }),
    (FlowChart.private.prototype.handlerTouchstartMousedownOnShape = function (
        ...
        if (r.selectable) {
            this.matchedShortcuts.includes("select_multiple_nodes")
                ...
                (this.chart.selectedShapes.clear(),
                    (r.selected = !0),
                    i && this.makeShapesVisible([r]));
            var s = {};
            for (var h of this.chart.selectedShapes) {
                if (!h.movable) return;
                s[h.id] = { x: h.x * a, y: h.y * a };
            }
            var l = FlowChart.private.getClientTouchesXY(t, 0),
                ...
                d = null,
                p = function (t) {
                    (o.chart.selectedPortShape = null),
                        o.chart.selectedShapes._.hideUI();
                    var e = FlowChart.private.getClientTouchesXY(t, 0);
                    for (var i of o.chart.selectedShapes)
                        (i.x = (e.x - l.x + s[i.id].x) / a),
                            (i.y = (e.y - l.y + s[i.id].y) / a);
                    if ("label" == r.type)
                        (n = (e.x - l.x) / a), (c = (e.y - l.y) / a);
                    else if ("psuedo-node" == r.type) {
                        var h = o.chart.links.getByShape(r)[0],
                            p = o.chart.ports.get(h.from, h.fromPort),
                            u = Number.MAX_VALUE,
                            f = null;
                        for (var w of o.chart.ports)
                            if (w.shape != r && w.shape != p.shape) {
                                var y = Math.hypot(w.x - r.x, w.y - r.y);
                                y < u && ((u = y), (f = w));
                            }
                        if (FlowChart.MAGNET_PORT > u) {
                            ...
                            (h.element.style.visibility = ""),
                                d && (o.chart.links.remove(d), (d = null));
                    }
                    "node" == r.type &&
                        FlowChart.private.magnet(
                            o.chart.selectedShapes.nodes,
                            o.chart.nodes,
                            o.chart.svgElement,
                            a
                        );
                ...
                u = function (t) {
                    "label" == r.type
                        ? (null == r.movex && (r.movex = 0),
                            ...
                            (r.movey += c))
                        : "psuedo-node" == r.type &&
                        (o.chart.nodes.remove(r),
                            d && (d.templateId = "rounded")),
                        o.chart.selectedShapes._.showUI(),
                        (o.chart.selectedPortShape = r),
                        FlowChart.private.removeAlignmentLineElements(
                            o.chart.svgElement
                        ),
                        o.chart.element.removeEventListener(e.move, p),
                        o.chart.element.removeEventListener(e.up, u),
                        e.leave &&
                        o.chart.element.removeEventListener(e.leave, u);
                };
            this.chart.element.addEventListener(e.move, p, { passive: !0 }),
                this.chart.element.addEventListener(e.up, u);
        }
    }),
    (FlowChart.private.prototype.handlerTouchstartMousedownOnResizeDot = function (
        t,
        e,
        r,
        i
        ...
        if (
            ...
            for (
                var a = i.parentNode;
                !a.hasAttribute("data-selector-shape-id");

            )
                a = a.parentNode;
            var s = a.getAttribute("data-selector-shape-id"),
                ...
                f = function (t) {
                    (o.chart.selectedPortShape = null),
                        o.chart.editor.clearFieldBorders();
                    var e = FlowChart.private.getClientTouchesXY(t, 0),
                        r = e.x - u.x,
                        a = u.y - e.y;
                    (r /= p), (a /= p);
                    var s = function (t) {
                        ...
                        f = i.getAttribute("data-selector-dot-2");
                    f == FlowChart.position.left
                        ...
                        FlowChart.private.magnetWhenResize(
                            ...
                            o.chart.nodes,
                            o.chart.svgElement,
                            i.getAttribute("data-selector-dot-2"),
                            p
                        );
                },
                w = function (t) {
                    var e = o.mouseActions.indexOf("resize-shape");
                    -1 != e &&
                        (o.mouseActions.splice(e, 1),
                            o.updateMatchedShortcuts(t)),
                        FlowChart.private.removeAlignmentLineElements(
                            o.chart.svgElement
                        ),
                        o.chart.element.removeEventListener(r.move, f),
                        o.chart.element.removeEventListener(r.up, w),
                        r.leave &&
                        o.chart.element.removeEventListener(r.leave, w);
                };
            this.chart.element.addEventListener(r.move, f, { passive: !0 }),
                this.chart.element.addEventListener(r.up, w);
        }
    }),
    (FlowChart.private.prototype.handlerTouchstartMousedownOnSvg = function (
        ...
        var a = this.chart.viewBox,
            ...
            n = {
                ...
                viewBoxLeft: a[0],
                viewBoxTop: a[1],
                viewBox: JSON.parse(JSON.stringify(a)),
            };
        e.touches &&
            e.touches.length > 1 &&
            ((n.type = "pinch"),
            ...
            "pan" == n.type &&
            o.chart.svgElement.classList.add("bfc-pan-cursor");
        var c = function (t) {
            var e = FlowChart.private.getClientTouchesXY(t, 0);
            if (n && "pan" == n.type) {
                (n.diffX = e.x - n.x0), (n.diffY = e.y - n.y0);
                var r = -n.diffY / s + n.viewBoxTop,
                    i = -n.diffX / s + n.viewBoxLeft;
                (a[0] = i), (a[1] = r), (o.chart.viewBox = a);
            ...
            d = function () {
                "pan" == n.type && o.chart.options.sticky,
                    "pan" == n.type &&
                    o.chart.svgElement.classList.remove("bfc-pan-cursor"),
                    (n = null),
                    o.chart.svgElement.removeEventListener(r.move, c),
                    o.chart.svgElement.removeEventListener(r.up, d);
            };
        this.chart.svgElement.addEventListener(r.move, c, { passive: !0 }),
            this.chart.svgElement.addEventListener(r.up, d);
    }),
    (FlowChart.private.prototype.handlerTouchstartMousedownOnShapeBarMove = function (
        t,
        e,
        r,
        i
        ...
        var o = this,
            a = FlowChart.private.getClientTouchesXY(e, 0),
            s = this.chart.shapeBar.element.getBoundingClientRect(),
            h = function (t) {
                var e = FlowChart.private.getClientTouchesXY(t, 0),
                    r = e.x - a.x + s.left,
                    i = e.y - a.y + s.top,
                    h = r - o.svgBCR.left;
                h < FlowChart.MAGNET_WIN_PIXELS &&
                    h > -FlowChart.MAGNET_WIN_PIXELS &&
                    (r = o.svgBCR.left);
                var l = o.svgBCR.right - (r + s.width);
                l < FlowChart.MAGNET_WIN_PIXELS &&
                    l > -FlowChart.MAGNET_WIN_PIXELS &&
                    (r = o.svgBCR.right - s.width);
                var n = i - o.svgBCR.top;
                n < FlowChart.MAGNET_WIN_PIXELS &&
                    n > -FlowChart.MAGNET_WIN_PIXELS &&
                    (i = o.svgBCR.top);
                var c = o.svgBCR.bottom - (i + s.height);
                c < FlowChart.MAGNET_WIN_PIXELS &&
                    c > -FlowChart.MAGNET_WIN_PIXELS &&
                    (i = o.svgBCR.bottom - s.height),
                    (o.chart.shapeBar.element.style.left = r + "px"),
                    (o.chart.shapeBar.element.style.top = i + "px");
                var d = { left: r, top: i };
                try {
            ...
            l = function (t) {
                o.chart.element.removeEventListener(r.move, h),
                    o.chart.element.removeEventListener(r.up, l),
                    r.leave && o.chart.element.removeEventListener(r.leave, l);
            };
        this.chart.element.addEventListener(r.move, h, { passive: !0 }),
            this.chart.element.addEventListener(r.up, l);
    }),
    (FlowChart.private.prototype.handlerMousewheel = function (t) {
        if (
            (this.mouseActions.includes("wheel") ||
                (this.mouseActions.push("wheel"),
                    this.updateMatchedShortcuts(t)),
                this.matchedShortcuts.includes("zoom"))
        ) {
            this.chart.selectedPort = null;
            var e = this,
                r = !1,
                i = this.chart.options.zoom.speed,
                o = this.chart.options.zoom.smooth,
                a = 0,
                s = this.chart.scale,
    ...
    (FlowChart.private.magnet = function (t, e, r, i) {
        var o = FlowChart.MAGNET_MOVE_PIXELS / i;
        if (0 != t.length) {
            var a = !1,
                s = !1;
            for (var h of (FlowChart.private.removeAlignmentLineElements(r),
                e)) {
                var l = !1;
                for (var n of t)
                    if (h == n) {
                ...
                if (!l)
                    for (var n of t) {
                        ...
                        if (
                            Math.abs(n.right - h.right) < o &&
                            n.right >= h.right - o &&
                            n.right <= h.right + o
                        ) {
                            if (!a) {
                                c = h.right - n.width / 2 - n.x;
                                for (var d of t) d.x += c;
                                a = !0;
                            }
                            var p, u;
                            if (Math.abs(n.right - h.right) < 0.5)
                                (p = n.top) > (u = h.top)
                                    ? (p += n.height)
                                    : (u += h.height),
                                    FlowChart.private.addAlignmentLineElement(
                        ...
                        if (
                            Math.abs(n.top - h.top) < o &&
                            n.top >= h.top - o &&
                            n.top <= h.top + o
                        ) {
                            if (!s) {
                                c = h.top + n.height / 2 - n.y;
                                for (var d of t) d.y += c;
                                s = !0;
                            }
                            if (Math.abs(n.top - h.top) < 0.5)
                                (f = n.left) > (w = h.left)
                                    ? (f += n.width)
                                    : (w += h.width),
                                    FlowChart.private.addAlignmentLineElement(
                        ...
                        if (
                            Math.abs(n.bottom - h.bottom) < o &&
                            n.bottom >= h.bottom - o &&
                            n.bottom <= h.bottom + o
                        ) {
                            if (!s) {
                                c = h.bottom - n.height / 2 - n.y;
                                for (var d of t) d.y += c;
                                s = !0;
                            }
                            var f, w;
                            if (Math.abs(n.bottom - h.bottom) < 0.5)
                                (f = n.left) > (w = h.left)
                                    ? (f += n.width)
                                    : (w += h.width),
                                    FlowChart.private.addAlignmentLineElement(
    ...
    (FlowChart.private.magnetWhenResize = function (t, e, r, i, o) {
        var a = !1,
            s = !1,
            h = FlowChart.MAGNET_RESIZE_PIXELS / o;
        for (var l of (FlowChart.private.removeAlignmentLineElements(r), e))
            if (t != l) {
                if (
                ...
                if (
                    ...
                    if (
                        ...
                        var n = 2 * (l.x - t.left),
                            c = t.width;
                        (t.width = n), (t.x += (n - c) / 2), (a = !0);
                    }
                    if (Math.abs(t.x - l.x) < 0.5)
                        (d = t.top) > (p = l.top)
                            ? (d += t.height)
                            : (p += l.height),
                            FlowChart.private.addAlignmentLineElement(
                ...
                if (
                    ...
                    if (!a) {
                        (n = l.right - t.left), (c = t.width);
                        (t.width = n), (t.x += (n - c) / 2), (a = !0);
                    }
                    var d, p;
                    if (Math.abs(t.right - l.right) < 0.5)
                        (d = t.top) > (p = l.top)
                            ? (d += t.height)
                            : (p += l.height),
                            FlowChart.private.addAlignmentLineElement(
                ...
                if (
                    ...
                    if (
                        ...
                        var u = 2 * (l.y - t.top),
                            f = t.height;
                        (t.height = u), (t.y += (u - f) / 2), (s = !0);
                    }
                    if (Math.abs(t.y - l.y) < 0.5)
                        (w = t.left) > (y = l.left)
                            ? (w += t.width)
                            : (y += l.width),
                            FlowChart.private.addAlignmentLineElement(
                ...
                if (
                    ...
                    if (!s) {
                        (u = l.bottom - t.top), (f = t.height);
                        (t.height = u), (t.y += (u - f) / 2), (s = !0);
                    }
                    var w, y;
                    if (Math.abs(t.bottom - l.bottom) < 0.5)
                        (w = t.left) > (y = l.left)
                            ? (w += t.width)
                            : (y += l.width),
                            FlowChart.private.addAlignmentLineElement(
    ...
    (FlowChart.private.addAlignmentLineElement = function (
        t,
        e,
        r,
        i,
    ...
    (FlowChart.private.removeAlignmentLineElements = function (t) {
        for (
            var e = t.querySelectorAll(".bfc-alignment-line"), r = 0;
            r < e.length;
            r++
        )
    ...
    (FlowChart.anim = class {
        ...
        static inOutPow(t) {
            if (t < 0) return 0;
            if (t > 1) return 1;
            if ((t *= 2) < 1) return FlowChart.anim.inPow(t, 2) / 2;
            ...
            return t < 0
                ...
                : t > 1
                    ...
                    : t < 0.5
                        ...
                        : 0.5 *
                        ((2 * t - 2) * (2 * t - 2) * (3.5949 * (2 * t - 2) + 2.5949) +
                            2);
        }
        static impulse(t) {
            var e = 2 * t;
    ...
    (FlowChart.LinkCollection = class extends Array {
        ...
        addRange(t) {
            ...
            return (
                this.push(...e),
                this._.chart._.changed({ property: "links" }),
                e
            );
        }
        add(t) {
        ...
        get(t, e, r, i) {
            for (var o of (null == r && (r = ""), null == i && (i = ""), this))
                if (
                    o.from == t &&
                    o.to == e &&
                    o.fromPort == r &&
        ...
        getByShape(t) {
            var e = [];
            for (var r of this) (r.from != t.id && r.to != t.id) || e.push(r);
            return e;
        }
        clear() {
            this._.remove(this);
    ...
    (FlowChart.LinkCollection.private = class {
        ...
        getProperty(t, e, r) {
            if (null == t[e]) {
                var i = FlowChart.linkTemplates[t.templateId];
                if (i[e] && "function" != typeof i[e]) return i[e];
            }
            if ("points" == e) {
                if (t[e]) return t[e];
                if (
                    (this.metadata[r.id] || (this.metadata[r.id] = {}),
                        null == this.metadata[r.id][e])
                ) {
                    if ("length" == e) return 0;
                    if ("points" == e) return [];
                }
                return this.metadata[r.id][e];
            }
            return Reflect.get(...arguments);
        }
        setProperty(t, e, r, i) {
            var o = FlowChart.linkTemplates[t.templateId];
            if (
                ("length" == e &&
                    (this.metadata[i.id] || (this.metadata[i.id] = {}),
                        (this.metadata[i.id].length = r)),
                    "points" == e)
            ) {
                for (var a = this, s = r, h = 0; h < s.length; h++) {
                    var l = s[h],
                        n = new Proxy(l, {
                            set(e, r, o) {
                                for (var s of ((e[r] = o),
                                    ...
                                    if (
                                        s.from == i.from &&
                                        s.to == i.to &&
                                        s.fromPort == i.fromPort &&
                                        s.toPort == i.toPort
                                    ) {
                                        var h = FlowChart.private.getLabelXY(
                                            s,
                                            i
                                        );
                                        (s.x = h.x), (s.y = h.y);
                ...
                var c = new Proxy(s, {
                    set: (t, e, r) => (
                        console.log(e), (t[e] = r), a.draw(i), !0
                    ),
                });
                this.metadata[i.id] || (this.metadata[i.id] = {}),
                    void 0 !== t.points && delete t.points,
                    (this.metadata[i.id].points = c);
            } else
                o[e] && "function" != typeof o[e]
                    ? (null != t[e] && o[e] == r && delete t[e],
                        o[e] != r
                            ? (t[e] = r)
                            : o[e] == r || FlowChart.isNEU(t[e]) || (t[e] = r))
                    : (t[e] = r);
        }
        addRange(t) {
            var e = this,
            ...
            for (var i = 0; i < t.length; i++) {
                var o = t[i];
                o.from || console.error("link.from not defined!"),
                    o.to || console.error("link.to not defined!"),
                    o.templateId ||
                    (o.templateId = FlowChart.DEFAULT_LINK_SHAPE_ID);
                var a = {
                    get(t, r, i) {
                        return "type" == r
                            ? "psuedo" == t.templateId
                                ...
                                : "link"
                            : ("fromPort" == r &&
                                FlowChart.isNEU(t.fromPort)) ||
                                ("toPort" == r && FlowChart.isNEU(t.toPort))
                                ? ""
                                : "element" == r
                                    ...
                                    : "pathElement" == r
                                        ? e.chart.svgElement.querySelector(
                                            `[data-link-id="${i.id}"] path`
                                        )
                                        : "layer" == r && FlowChart.isNEU(t.layer)
                                            ? -2
                                            : "id" == r
                                                ? `${i.from}${FlowChart.SEPARATOR}${i.fromPort}${FlowChart.SEPARATOR}${i.to}${FlowChart.SEPARATOR}${i.toPort}`
                    ...
                    set(t, r, i, o) {
                        ...
                        e.chart._.snap();
                        var s = e.beforeIdChange(r, o);
                        for (var h of (e.setProperty(t, r, i, o),
                            e.afterIdChange(s, o),
                            e.draw(o),
                            e.chart.labels))
                            if (
                                h.from == o.from &&
                                h.to == o.to &&
                                h.fromPort == o.fromPort &&
                                h.toPort == o.toPort
                            ) {
                                var l = FlowChart.private.getLabelXY(h, o);
                                (h.x = l.x), (h.y = l.y);
                            }
                    ...
                    h = o.points;
                if (!h) {
                    var l = this.chart.ports.getByLink(o);
                            ...
                            set(t, r, i) {
                                for (var o of ((t[r] = i),
                                    ...
                                    if (
                                        o.from == s.from &&
                                        o.to == s.to &&
                                        o.fromPort == s.fromPort &&
                                        o.toPort == s.toPort
                                    ) {
                                        var a = FlowChart.private.getLabelXY(
                                            o,
                                            s
                                        );
                                        (o.x = a.x), (o.y = a.y);
                ...
                var p = new Proxy(h, {});
                this.setProperty(o, "points", p, s), this.draw(s), r.push(s);
            }
            return r;
        }
        beforeIdChange(t, e) {
        ...
        afterIdChange(t, e) {
            if (t) {
                ...
                var r = this.chart.ports.getByLink(e),
                    i = FlowChart.private.linkFromTo(
                        r.fromShape,
                        r.toShape,
                        r.fromPort,
                        r.toPort,
                ...
                for (var o of ((e.points = i), this.chart.labels))
                    o.from == t.from &&
                        o.to == t.to &&
                        o.fromPort == t.fromPort &&
                        o.toPort == t.toPort &&
                        ((o.from = e.from),
                            (o.to = e.to),
                            (o.fromPort = e.fromPort),
                            (o.toPort = e.toPort));
            }
        }
        remove(t, e) {
            ...
            else for (var o of e) (o.from != t && o.to != t) || i.push(o);
            for (var o of i)
                for (var a = e.length - 1; a >= 0; a--)
                    if (e[a].from == o.from && e[a].to == o.to) {
                        var s = o.element;
                        for (var h of (s && s.parentNode.removeChild(s),
                            this.chart.labels))
                            h.from == o.from &&
                                h.to == o.to &&
                                this.chart.labels.remove(h);
                        r || (this.chart._.snap(), (r = !0)), e.splice(a, 1);
                        break;
                    }
            r && this.chart._.changed({ property: "links" });
        }
        ...
        draw(t) {
            var e = this.chart.svgElement.querySelector(
                ...
                r = FlowChart.linkTemplates[t.templateId];
            if (!e) {
                var i = t.stroke.replace(/\W/g, "_"),
                    o = `bfc_mstart_${t.templateId}_${i}`,
                    a = `bfc_mend_${t.templateId}_${i}`;
                (e = document.createElementNS(
                    ...
                    (e.innerHTML =
                        r.svg(t, o, a) +
                        '<path d="" class="bfc-link-invisible"></path>'),
                    FlowChart.private
    ...
    (FlowChart.PortCollection = class {
        ...
        [Symbol.iterator]() {
            ...
            return {
                next() {
                    for (var h; !h && !a;)
                        if (i > e.length + t.length - 1) a = !0;
                        else {
                            var l;
                            l = i < t.length ? t[i] : e[i - t.length];
                            var n = FlowChart.shapeTemplates[
                                l.templateId
                            ].ports(l);
                            n
                                ? (null == s && (s = Object.keys(n)),
                                    (h = r.get(l.id, s[o])))
                                : (s = []),
                                ++o > s.length - 1 &&
                                ((s = null), (o = 0), i++);
                        }
                    return { value: h, done: a };
                },
            };
        }
        getElement(t) {
    ...
    (FlowChart.PortCollection.private = class {
        ...
        getElement(t) {
            return this.chart.svgElement.querySelector(
                `[data-ports-s-id="${t}"]`
            );
        }
        getByPosition(t, e) {
            var r = FlowChart.shapeTemplates[t.templateId],
                i = [];
            for (var o in r.ports(t)) {
                FlowChart.private.getPortPosition(r.ports(t)[o], t) == e &&
                    i.push(this.get(t.id, o));
            }
            return i;
        }
        getByOpositeOfPosition(t, e) {
            ...
            switch (e) {
                ...
                case FlowChart.position.bottomLeft:
                    ...
                    break;
                case FlowChart.position.topLeft:
                    r = FlowChart.position.bottomRight;
                    break;
                case FlowChart.position.left:
                    r = FlowChart.position.right;
                    break;
                case FlowChart.position.right:
                    r = FlowChart.position.left;
                    break;
                case FlowChart.position.top:
                    r = FlowChart.position.bottom;
                    break;
                case FlowChart.position.bottom:
                    r = FlowChart.position.top;
            }
            var i = this.chart.getShape(t);
            return this.getByPosition(i, r);
        }
        getByLink(t) {
            var e, r, i, o, a;
            return (
                ...
                FlowChart.isNEU(t.fromPort) ||
                (i = this.get(t.from, t.fromPort)),
                (r = this.chart.getShape(t.to)),
                FlowChart.isNEU(t.toPort) || (o = this.get(t.to, t.toPort)),
                (i && o) ||
                ((a = FlowChart.private.findClosestPorts(e, r)),
                    i || (i = this.get(t.from, a.fromPortName)),
                    o || (o = this.get(t.to, a.toPortName))),
                { fromShape: e, toShape: r, fromPort: i, toPort: o }
            );
        }
        get(t, e) {
            var r = this.chart.getShape(t),
                i = FlowChart.shapeTemplates[r.templateId],
                o = FlowChart.private.getPortPosition(i.ports(r)[e], r),
                a = JSON.parse(JSON.stringify(i.ports(r)[e]));
            if (!a) return null;
            for (var s of ((a.id = e),
                (a.x += r.left),
                (a.y += r.top),
        ...
        for (var r of t)
            switch (r) {
                ...
                case "links":
                    ...
                    break;
                case "selectedShapes":
                    for (var i of ((e.selectedShapes = []),
                        this.chart.selectedShapes))
                        e.selectedShapes.push(i.id);
                    break;
                case "viewBox":
    ...
    (FlowChart.private.prototype.svg = function () {
        ...
        var e = t.querySelector("svg"),
            r = this.chart.nodes,
            i = {
                left: r.left - FlowChart.PADDING,
                top: r.top - FlowChart.PADDING,
                right: r.right + FlowChart.PADDING,
                bottom: r.bottom + FlowChart.PADDING,
            };
        return (
            ...
            e.setAttribute("width", i.right - i.left),
            e.setAttribute("height", i.bottom - i.top),
            t.innerHTML
        );
    }),
    (FlowChart.events = class {
        ...
        static on(t, e, r) {
            Array.isArray(FlowChart.events.topics[t]) ||
                ...
                FlowChart.events.topics[t].push({ listener: e, uid: r });
        }
        static removeAll(t) {
            Array.isArray(FlowChart.events.topics[t]) ||
                (FlowChart.events.topics[t] = []),
        ...
        static has(t, e) {
            if (
                ...
                for (var r = 0; r < FlowChart.events.topics[t].length; r++)
                    if (FlowChart.events.topics[t][r].uid == e) return !0;
            }
            return !1;
        }
        static removeForEventId(t) {
            for (var e in FlowChart.events.topics)
                if (Array.isArray(FlowChart.events.topics[e]))
                    for (
                        var r = FlowChart.events.topics[e].length - 1;
                        r >= 0;
                        r--
                    )
                        FlowChart.events.topics[e][r].uid == t &&
                            FlowChart.events.topics[e].splice(r, 1);
        }
        static publish(t, e) {
            if (FlowChart.events.topics[t]) {
                for (
                    var r = [], i = 0;
                    i < FlowChart.events.topics[t].length;
                    i++
                ) {
                    var o = FlowChart.events.topics[t][i];
                    (null != o._ && null != o._.uid && o._.uid != e[0]._.uid) ||
                        r.push(o.listener);
                }
                if (r.length > 0) {
                    var a = !0;
                        ...
                        (1 == e.length
                            ...
                            : 2 == e.length
                                ...
                                : 3 == e.length
                                    ? (a = r[i](e[0], e[1], e[2]) && a)
                                    : 4 == e.length
                                        ? (a = r[i](e[0], e[1], e[2], e[3]) && a)
                                        : 5 == e.length &&
                                        (a = r[i](e[0], e[1], e[2], e[3], e[4]) && a),
                            !1 !== a);
                        i++
                    );
                    return a;
    ...
    (FlowChart.icon = class {
        ...
        static barChartReport(t, e, r, i, o) {
        ...
        static bookmarkMarkPin(t, e, r, i, o) {
        ...
        static calendarDateSchedule(t, e, r, i, o) {
        ...
        static closeFolderData(t, e, r, i, o) {
        ...
        static fileFormatFolder(t, e, r, i, o) {
        ...
        static fullscreenArrowsExpand(t, e, r, i, o) {
        ...
        static imagePictureGallery(t, e, r, i, o) {
        ...
        static linkChainConnect(t, e, r, i, o) {
        ...
        static minimizeResizeDirection(t, e, r, i, o) {
        ...
        static openFolderStorage(t, e, r, i, o) {
        ...
        static pasteClipboardfiles(t, e, r, i, o) {
        ...
        static pencilToolPen(t, e, r, i, o) {
        ...
        static pieChartReport(t, e, r, i, o) {
        ...
        static printInkjetPrinting(t, e, r, i, o) {
        ...
        static researchChemistryEducation(t, e, r, i, o) {
        ...
        static resizeExpandScale(t, e, r, i, o) {
        ...
        static saveStorageFolder(t, e, r, i, o) {
        ...
        static searchGlassview(t, e, r, i, o) {
        ...
        static sendShareCommunication(t, e, r, i, o) {
        ...
        static settingGearCogwheel(t, e, r, i, o) {
        ...
        static shareSendNetwork(t, e, r, i, o) {
        ...
        static spacingTextParagraph(t, e, r, i, o) {
        ...
        static tableCellsChart(t, e, r, i, o) {
        ...
        static textAlignCenter(t, e, r, i, o) {
        ...
        static textAlignLeft(t, e, r, i, o) {
        ...
        static textAlignRight(t, e, r, i, o) {
    ...
    (FlowChart.ShapeCollection = class extends Array {
        ...
        addRange(t) {
            ...
            return (
                this.push(...e),
                this._.chart._.changed({ property: "shapes" }),
                e
            );
        }
        add(t) {
        ...
        get(t) {
            ...
            var r = arguments[0],
                ...
                a = arguments[3],
                s = arguments[4];
            for (var e of (null == a && (a = ""), null == s && (s = ""), this))
                if (
                    e.from == r &&
                    e.to == i &&
                    e.position == o &&
    ...
    (FlowChart.ShapeCollection.private = class {
        ...
        getProperty(t, e, r) {
            if (null == t[e]) {
                ...
                if (null != i[e] && "function" != typeof i[e]) return i[e];
            }
            if ("x" == e || "y" == e) {
                if ("label" == r.type) return this.metadata[r.id][e];
                if (null == t[e]) return 0;
            }
            return Reflect.get(...arguments);
        }
        setProperty(t, e, r, i) {
            var o = FlowChart.shapeTemplates[t.templateId];
            if ("label" != i.type || ("x" != e && "y" != e))
                if (o[e] && "function" != typeof o[e])
                    (t[e] == o[e]) == r && delete t[e],
                        o[e] != r
                            ? (t[e] = r)
                            : o[e] != r || FlowChart.isNEU(t[e]) || (t[e] = r);
                else {
                    if (
                        ...
                        var a = { shape: i, newValue: r, fieldName: e };
                        return (
                            !1 !==
                            FlowChart.events.publish("field-change", [
                                this.chart,
                                a,
                            ]) && (t[e] = r),
                            !0
                ...
                this.metadata[i.id] || (this.metadata[i.id] = {}),
                    (this.metadata[i.id][e] = r);
        }
        setSelected(t, e) {
            0 == t.selectable && (e = !1);
            var r = t.selected,
                i = this.getMetadata(t.id);
            r != e &&
                ((i.selected = e),
                    !r && e
        ...
        setWidth(t, e) {
            if (t.canWidthFitContent) {
                var r = FlowChart.shapeTemplates[t.templateId],
                    i = this.getMetadata(t.id);
                e < r.minWidth && (e = r.minWidth),
                    i.width != e &&
                    ((i.width = e), (t.SYSTEM_CHANGE_SIZE = !0));
            } else t.width = e;
        }
        setHeight(t, e) {
            if (t.canHeightFitContent) {
                var r = FlowChart.shapeTemplates[t.templateId],
                    i = this.getMetadata(t.id);
                e < r.minHeight && (e = r.minHeight),
                    i.height != e &&
                    ((i.height = e), (t.SYSTEM_CHANGE_SIZE = !0));
            } else t.height = e;
        }
        addRange(t) {
            for (var e = [], r = 0; r < t.length; r++) {
                var i = t[r];
                if (FlowChart.private.isLabel(i)) {
                    i.templateId ||
                        (i.templateId = FlowChart.DEFAULT_LABEL_SHAPE_ID);
                    var o = "";
                    FlowChart.isNEU(i.fromPort) || (o = i.fromPort);
                    var a = "";
                    FlowChart.isNEU(i.toPort) || (a = i.toPort);
                    var s = this.chart.links.get(i.from, i.to, o, a),
                        h = FlowChart.private.getLabelXY(i, s),
                        l = `${i.from}${FlowChart.SEPARATOR}${o}${FlowChart.SEPARATOR}${i.to}${FlowChart.SEPARATOR}${a}${FlowChart.SEPARATOR}${i.position}`;
                    (this.metadata[l] = {}),
        ...
        set(t) {
            ...
            FlowChart.shapeTemplates[t.templateId] ||
                console.error(
                    `Shape template "${t.templateId}" does not exist!`
                ),
            ...
            var i = function (t, r) {
                ...
                if (!(h = t.element)) {
                    ...
                    c < 0 && (c = 0),
                        d < 0 && (d = 0),
                        (h.innerHTML = `<g class="bfc-svg">${a}</g>\n                                             <foreignObject pointer-events="all" class="bfc-html" x="${l}" y="${n}" width="${d}" height="${c}"><div data-html-container class="bfc-flex-center">${o}</div></foreignObject>`),
                        h.setAttribute("id", t.id),
                        h.setAttribute("ondblclick", "OpenFormDesign(this.id);"),
                ...
                if (null != r) {
                    ...
                    if ("x" == r || "y" == r) {
                        ...
                        "width" == r ||
                        "height" == r ||
                        "SYSTEM_CHANGE_SIZE" == r
                    ) {
                        s = i.offset(t);
                        f.innerHTML = i.svg(t);
                        var w = t.width - t.strokeWidth,
                            y = t.height - t.strokeWidth;
                        w < 0 && (w = 0),
                            y < 0 && (y = 0),
                            u.setAttribute("width", w),
                            u.setAttribute("height", y),
                            h.setAttribute(
                                "transform",
                                `translate(${t.left + s.x},${t.top + s.y})`
                            );
                    ...
                    if (
                        ...
                        for (var m of (e.chart.selectedShapes._.update(
                            t,
                            e.chart.scale
                        ),
                            e.chart._.updatePortsElement(e.chart.scale),
                            e.chart.links))
                            if (m.from == t.id || m.to == t.id) {
                                var g = e.chart.ports.getByLink(m),
                                    v = FlowChart.private.linkFromTo(
                                        g.fromShape,
                                        g.toShape,
                                        g.fromPort,
                                        g.toPort,
                    ...
                    if (
                        ...
                        o = (i =
                            FlowChart.shapeTemplates[t.templateId]).html(t);
                        if (
                            ((p.innerHTML = o),
                                (f.innerHTML = i.svg(t)),
                                t.canWidthFitContent || t.canHeightFitContent)
                        ) {
                            var C = e.chart._.getSizeOfHTML(o);
                            if (t.canWidthFitContent) {
                                var N = C.width;
                                N < i.minWidth && (N = i.minWidth),
                                    e.setWidth(t, N);
                            }
                            if (t.canHeightFitContent) {
                                var x = C.height;
                                x < i.minHeight && (x = i.minHeight),
                                    e.setHeight(t, x);
                            }
                        }
                    }
                    "opacity" == r && (h.style.opacity = t[r]);
                }
            },
                o = new Proxy(t, {
                    deleteProperty(t, r, o) {
                        delete t[r];
                        o = e.chart.getShape(t.id);
                        return i(o, r), !0;
                    },
                    get(t, r, i) {
                        var o = FlowChart.shapeTemplates[t.templateId];
                                        ...
                                        : ("fromPort" == r &&
                                            ...
                                            : "layer" == r && FlowChart.isNEU(t.layer)
                                                ? "label" == i.type
                                                    ...
                                                    : -3
                                                : "id" == r && "label" == i.type
                                                    ? `${i.from}${FlowChart.SEPARATOR}${i.fromPort}${FlowChart.SEPARATOR}${i.to}${FlowChart.SEPARATOR}${i.toPort}${FlowChart.SEPARATOR}${i.position}`
                                                    : "width" == r &&
                                                        "fit" == o.width &&
                                                        null == t.width
                                                        ? e.metadata[i.id] && null != e.metadata[i.id].width
                                                            ? e.metadata[i.id].width
                                                            : o.width
                                                        : "height" == r &&
                                                            "fit" == o.height &&
                                                            null == t.height
                                                            ? e.metadata[i.id] &&
                                                                null != e.metadata[i.id].height
                                                                ? e.metadata[i.id].height
                                                                : o.height
                                                            : "selected" == r
                                                                ? !(
                                                                    !e.metadata[i.id] ||
                                                                    1 != e.metadata[i.id].selected
                                                                )
                                                                : ("canWidthFitContent" == r &&
                                                                    "fit" == o.width &&
                                                                    null == t.width) ||
                                                                ("canHeightFitContent" == r &&
                                                                    "fit" == o.height &&
                                                                    null == t.height) ||
                                                                ("element" == r
                                                                    ? e.getElement(i.id)
                    ...
                    set(t, r, o, a) {
                        ...
                        if (
                            ("width" == r && o < s.minWidth && (o = s.minWidth),
                                "height" == r &&
                                o < s.minHeight &&
                                (o = s.minHeight),
                                "selected" == r && e.setSelected(a, o),
                                "to" == r ||
                                "from" == r ||
                                "fromPort" == r ||
                                "toPort" == r ||
                        ...
                        if ("SYSTEM_CHANGE_SIZE" != r && "selected" != r) {
                            e.chart._.snap();
                            var l = e.beforeIdChange(r, a, t);
                            e.setProperty(t, r, o, a), e.afterIdChange(l, a);
                        }
                        return (
                            i(a, r),
                            "SYSTEM_CHANGE_SIZE" != r &&
                ...
                a = FlowChart.shapeTemplates[t.templateId];
            if ("fit" == a.width || "fit" == a.height) {
                var s = a.html(o),
                    h = this.chart._.getSizeOfHTML(s);
                if ("fit" == a.width) {
                    var l = h.width;
                    l < a.minWidth && (l = a.minWidth),
                        this.metadata[o.id] || (this.metadata[o.id] = {}),
                        (this.metadata[o.id].width = l);
                }
                if ("fit" == a.height) {
                    var n = h.height;
                    n < a.minHeight && (n = a.minHeight),
                        this.metadata[o.id] || (this.metadata[o.id] = {}),
                        (this.metadata[o.id].height = n);
                }
            }
            return i(o), this.minMax(o), o;
        }
        beforeIdChange(t, e) {
            var r = null;
            return (
        ...
        afterIdChange(t, e) {
            if (t)
                if (((this.metadata[e.id] = t.metadata), "label" == e.type))
                    for (var r of this.chart.links)
                        r.from == t.from &&
                            r.to == t.to &&
                            r.fromPort == t.fromPort &&
                            r.toPort == t.toPort &&
                            ((r.from = e.from),
                                (r.to = e.to),
                                (r.fromPort = e.fromPort),
                                (r.toPort = e.toPort));
                else
                    for (var r of this.chart.links)
                        r.from == t.id && (r.from = e.id),
                            r.to == t.id && (r.to = e.id);
        }
        getElement(t) {
            return this.chart.svgElement.querySelector(
        ...
        remove(t, e) {
            ...
            t instanceof FlowChart.SelectedShapeCollection ||
                ...
                (t = [t]);
            var i = [];
            for (var o of t) i.push(o.id);
            for (var a of i)
                for (var s = e.length - 1; s >= 0; s--)
                    if (e[s].id == a) {
                        ((o = e[s]).selected = !1),
                            (this.chart.selectedPortShape = null);
                        var h = this.getElement(a);
                        h && h.parentNode.removeChild(h),
                            this.chart.links.remove(a),
                            r || (this.chart._.snap(), (r = !0)),
                            this.metadata[o.id] && delete this.metadata[o.id],
                            e.splice(s, 1);
                        break;
                    }
            r &&
            ...
            if (t.length)
                if (e) {
                    if (
                        ...
                        var a = 1;
                        FlowChart.isNEU(i) && (i = FlowChart.anim.inSin),
                            FlowChart.isNEU(o) && (o = 1100),
                            (e != FlowChart.move.left &&
                                e != FlowChart.move.right) ||
                            (this.moveHorizontallyInterval = setInterval(
                                s,
                                10
                            )),
                            (e != FlowChart.move.up &&
                                e != FlowChart.move.down) ||
                            (this.moveVerticallyInterval = setInterval(
                                s,
                                10
                            ));
                    }
        ...
        minMax(t) {
            "node" == t.type &&
                (t.left < this.minX &&
                    ((this.minX = t.left), (this.minShapeX = t)),
                    t.top < this.minY &&
                    ((this.minY = t.top), (this.minShapeY = t)),
                    t.right > this.maxX &&
                    ((this.maxX = t.right), (this.maxShapeX = t)),
                    t.bottom > this.maxY &&
                    ((this.maxY = t.bottom), (this.maxShapeY = t)));
        }
        minMaxIterateAll(t) {
    ...
    (FlowChart.shapeTemplates = class {
        static base = class {
            ...
            static html(t) {
                return `<div style="padding: 10px;">\n                        <div data-field="text"> ${null == t.text ? `[${t.displayName}]` : t.text
                    }</div>                       \n                    </div>`;
            }
            static ports(t) {
                return {
    ...
    (FlowChart.shapeTemplates.start = class extends (
        FlowChart.shapeTemplates.base
    ) {
        static svg(t) {
            var e = (t.height / 100) * 45;
            return `<rect id="ISStart" rx="${e}" ry="${e}" x="0" y="0" width="${t.width}" height="${t.height}" style="stroke:${t.stroke}; fill:${t.fill}; stroke-width:${t.strokeWidth};" ></rect>`;
        }
    ...
    (FlowChart.shapeTemplates.document = class extends (
        ...
        static svg(t) {
            ...
            return `<path d="M0,0 L0,${t.height} Q ${t.width / 4} ${t.height + e
                }, ${t.width / 2} ${t.height} T ${t.width} ${t.height} L${t.width
                },${t.height} L${t.width},0 Z" style="stroke:${t.stroke}; fill:${t.fill
    ...
    (FlowChart.shapeTemplates.decision = class extends (
        ...
        static svg(t) {
            return `<path  d="M${t.width / 2},0 L${t.width},${t.height / 2} L${t.width / 2
                },${t.height} L0,${t.height / 2} Z" style="stroke:${t.stroke
                }; fill:${t.fill}; stroke-width:${t.strokeWidth};" /></path>`;
        }
        static width = 200;
        static height = 180;
        static displayInShapeBar = !0;
    ...
    (FlowChart.shapeTemplates.End = class extends (
        FlowChart.shapeTemplates.base
    ) {
        static svg(t) {
            var e = (t.height / 100) * 45;
            return `<rect Id="ISEnd" rx="${e}" ry="${e}" x="0" y="0" width="${t.width}" height="${t.height}" style="stroke:${t.stroke}; fill:${t.fill}; stroke-width:${t.strokeWidth};" ></rect>`;
        }
        static ports(t) {
            var e = t.width / 10 / 2;
            return {
    ...
    (FlowChart.shapeTemplates.Notification = class extends (
        FlowChart.shapeTemplates.base
    ) {
    ...
    (FlowChart.shapeTemplates.Escal = class extends (
        FlowChart.shapeTemplates.base
    ) {
        static displayName = "Escal";
        static svg(t) {
            return `<path  d="M${t.width / 2},0 L${t.width},${t.height / 2} L${t.width / 2
                },${t.height} L0,${t.height / 2} Z" style="stroke:${t.stroke
                }; fill:${t.fill}; stroke-width:${t.strokeWidth};" /></path>`;
    ...
    (FlowChart.shapeTemplates.manualInput = class extends (
        ...
        static svg(t) {
            return `<path d="M0,${t.width / 10} L0,${t.height} L${t.width},${t.height
                } L${t.width},0 Z" style="stroke:${t.stroke}; fill:${t.fill
                }; stroke-width:${t.strokeWidth};"></path>`;
        }
        static ports(t) {
            var e = t.width / 20;
    ...
    (FlowChart.shapeTemplates.preparation = class extends (
        ...
        static svg(t) {
            var e = t.width / 10;
            return `<path d="M${e},0 L0,${t.height / 2} L${e},${t.height} L${t.width - e
                },${t.height} L${t.width},${t.height / 2} L${t.width - e
                },0 Z" style="stroke:${t.stroke}; fill:${t.fill}; stroke-width:${t.strokeWidth
                };"></path>`;
        }
    ...
    (FlowChart.shapeTemplates.or = class extends (
        ...
        static svg(t) {
            return (
                ...
                `<line x1="${t.width / 2}" y1="0" x2="${t.width / 2}" y2="${t.height
                }" style="stroke:${t.stroke}; stroke-width:${t.strokeWidth
                };"></line>\n            <line x1="0" y1="${t.height / 2
                }" x2="${t.width}" y2="${t.height / 2}" style="stroke:${t.stroke
                }; stroke-width:${t.strokeWidth};"></line>`
            );
        }
        static html(t) {
            return "";
    ...
    (FlowChart.shapeTemplates.data = class extends (
        FlowChart.shapeTemplates.base
    ) {
        static svg(t) {
            var e = t.width / 10;
            return `<path d="M0,${t.height} C${-e},${t.height} ${-e},0 0,0 L${t.width
                },0 C${t.width - e},0 ${t.width - e},${t.height} ${t.width},${t.height
                } Z" style="stroke:${t.stroke}; fill:${t.fill}; stroke-width:${t.strokeWidth
                };"/>`;
        }
    ...
    (FlowChart.shapeTemplates.delay = class extends (
        ...
        static svg(t) {
            var e = t.width / 4,
                r = t.width / 5;
            return `<path d="M0,${t.height} L0,0 L${t.width - r},0 C${t.width + e - r
                },0 ${t.width + e - r},${t.height} ${t.width - r},${t.height
                } Z" style="stroke:${t.stroke}; fill:${t.fill}; stroke-width:${t.strokeWidth
                };"/>`;
        }
    ...
    (FlowChart.shapeTemplates.display = class extends (
        ...
        static svg(t) {
            var e = t.width / 4,
                r = t.width / 5,
                i = t.width / 10;
            return `<path d="M${i},${t.height} L0,${t.height / 2} L${i},0  L${t.width - r
                },0 C${t.width + e - r},0 ${t.width + e - r},${t.height} ${t.width - r
                },${t.height} Z" style="stroke:${t.stroke}; fill:${t.fill
    ...
    (FlowChart.shapeTemplates.manualLoop = class extends (
        ...
        static svg(t) {
            var e = t.width / 10;
            return `<path d="M0,0 L${t.width},0 L${t.width - e},${t.height
                } L${e},${t.height} Z" style="stroke:${t.stroke}; fill:${t.fill
                }; stroke-width:${t.strokeWidth};"></path>`;
        }
    ...
    (FlowChart.shapeTemplates.loopLimit = class extends (
        ...
        static svg(t) {
            var e = t.width / 6;
            return `<path d="M0,${e} L${e},0 L${t.width - e},0 L${t.width
                },${e} L${t.width},${t.height} L0,${t.height} Z" style="stroke:${t.stroke
                }; fill:${t.fill}; stroke-width:${t.strokeWidth};"></path>`;
        }
    ...
    (FlowChart.shapeTemplates.psuedo = class extends (
        ...
        static svg(t) {
            return `<circle r="${t.width / 2}" cx="${t.width / 2}" cy="${t.height / 2
                }" style="stroke:${t.stroke}; fill:${t.fill
    ...
    (FlowChart.MenuBar = class {
        ...
        showColorPalette() {
            this._.showColorPalette();
        }
        hideColorPalette() {
            this._.hideColorPalette();
        }
        init() {
            this._.init();
        }
    ...
    (FlowChart.MenuBar.private = class {
        ...
        init() {
            for (var t = "", e = 0; e < this.chart.options.colors.length; e++) {
                t += `<div class="bfc-menu-item" data-color-item="${e}" data-menu-item="color-${e}"><div class="bfc-color-item"  style="background-color: ${this.chart.options.colors[e]
                    }">${e + 1}</div></div>`;
            }
            t &&
                (t = `<div data-color-palette class="bfc-color-palette">${t}</div>`),
        ...
        colorMenuBarRefresh() {
            ...
            for (var r of t.children)
                this.chart.options.interactive && -1 != e.indexOf("shape")
                    ? r.classList.remove("bfc-disabled-grayscale")
                    : r.classList.add("bfc-disabled-grayscale");
        }
        undoReduRefresh() {
            var t = this.chart.element.querySelector('[data-menu-item="undo"]');
            t &&
                (this.chart.options.interactive ||
                    0 != this.chart._.undoStepsCount()
        ...
        handlerClick(t, e, r) {
            var i = { event: t, name: e };
            if (
                !1 !==
                FlowChart.events.publish("menu-item-click", [
                    this.chart,
                    i,
                ]) &&
    ...
    (FlowChart.private.prototype.showPortsUI = function () {
        ...
        !t &&
            ...
            ((t = document.createElementNS(
                ...
                (t.innerHTML = this.portHTMLUI(
                    this.selectedPortShape,
                    this.chart.scale
                )),
    ...
    (FlowChart.private.prototype.updatePortsElement = function (t) {
        ...
        if (e) {
            ...
            var r = e.getAttribute("data-ports-s-id"),
                i = this.chart.getShape(r);
            e.innerHTML = this.portHTMLUI(i, t);
        }
    }),
    (FlowChart.private.prototype.portHTMLUI = function (t, e) {
        var r = "",
            i = FlowChart.shapeTemplates[t.templateId],
            o = i.ports(t);
        if (!FlowChart.isNEU(o)) {
            for (var a in o) {
                var s = o[a],
                    h = 40,
                    l = 40,
                    ...
                    c = s.y,
                    d = 0;
                switch (FlowChart.private.getPortPosition(s, t)) {
                    case FlowChart.position.topRight:
                        (c -= l / e), (d = 45);
                        break;
                    case FlowChart.position.bottomRight:
                ...
                r += `<g class="bfc-port-out" data-port-out-port="${a}" data-port-out-shape="${t.id
                    }" transform="rotate(${d})"><rect style="opacity: 0" x="${n}" y="${c}" width="${h / e
                    }" height="${l / e}"></rect>${FlowChart.icon.arrow(
                        h / e,
                        l / e,
                        "#ffca28",
                        n,
            ...
            r =
                `<rect style="opacity: 0" x="${-h / e}" y="${-l / e}"  width="${t.width + (h / e) * 2
                }" height="${t.height + (l / e) * 2}"></rect>` + r;
        }
        return r;
    }),
    (FlowChart.private.prototype.hidePortShapeBarUI = function () {
        for (
            var t = this.chart.element.querySelectorAll("[data-portsb-shape]"),
            e = 0;
            e < t.length;
            e++
        )
    ...
    (FlowChart.private.prototype.portShapeBarHTMLUI = function () {
        ...
        for (var e in FlowChart.shapeTemplates) {
            var r = FlowChart.shapeTemplates[e];
            if (r.displayInPortShapeBar) {
                var i = { templateId: e };
                (i.width = "fit" == r.width ? r.minWidth : r.width),
                    (i.height = "fit" == r.height ? r.minHeight : r.height),
                    (i.fill = r.fill),
                    (i.stroke = r.stroke),
                    (i.strokeWidth = r.strokeWidth),
                    (t += `<div data-portshapebar-item-id="${e}">\n                    <svg class="bfc-portshapebar-svg ${i.templateId
    ...
    (FlowChart.private.prototype.showPortShapeBarUI = function (t) {
        var e = this.chart.ports.getByPosition(
    ...
    (FlowChart.private.prototype.navigatePortShapeBarItems = function (t) {
        ...
        if (e) {
            var r = e.getAttribute("data-portsb-shape"),
                i = e.getAttribute("data-portsb-port"),
                o = this.chart.ports.get(r, i),
                a = FlowChart.shapeTemplates[o.shape.templateId],
                s = FlowChart.private.getPortPosition(
                    a.ports(o.shape)[o.id],
                    o.shape
                );
            s == FlowChart.position.left &&
                (t == FlowChart.position.bottom &&
                    this.selectPortShapeShapeBarItem(!0),
                    t == FlowChart.position.top &&
                    this.selectPortShapeShapeBarItem(!1),
                    t == FlowChart.position.right &&
                    this.showPortShapeBarByPosition(t)),
                s == FlowChart.position.right &&
                (t == FlowChart.position.bottom &&
                    this.selectPortShapeShapeBarItem(!0),
                    t == FlowChart.position.top &&
                    this.selectPortShapeShapeBarItem(!1),
                    t == FlowChart.position.left &&
                    this.showPortShapeBarByPosition(t)),
    ...
    (FlowChart.private.prototype.showPortShapeBarByPosition = function (t) {
        ...
        if (e && e.length) {
            var r = e[0];
            this.showPortShapeBar(r), this.selectPortShapeShapeBarItem(!1);
        }
    }),
    (FlowChart.private.prototype.createNodeFromPorsShapeBarItem = function () {
        ...
        var t = this,
            e = this.selectedPort,
            r = this.chart.element.querySelector(
                `[data-portsb-shape="${e.shape.id}"][data-portsb-port="${e.id}"]`
            ),
            i = r.querySelector(".bfc-portshapebar-selected");
        if (i) {
            this.chart.editor.hasActiveField() && this.chart.editor.blur();
            var o = r.getAttribute("data-portsb-shape"),
                a = r.getAttribute("data-portsb-port"),
                s = this.chart.ports.get(o, a),
                h = i.getAttribute("data-portshapebar-item-id");
            (this.lastAddedTemplateIdFormPortShapeBar = h),
                this.addNodeWithLink(s, h, function (e, r) {
                    t.chart.selectedShapes.clear(),
                        t.chart.selectedShapes.add(e);
                });
        }
    }),
    (FlowChart.private.prototype.selectPortShapeShapeBarItem = function (t, e) {
        var r = this.chart.element.querySelector("[data-portsb-shape]");
        if (r) {
            for (
                var i = r.querySelectorAll("[data-portshapebar-item-id]"),
                o = -1,
                a = 0;
                a < i.length;
                a++
            ) {
                (s = i[a]).classList.contains("bfc-portshapebar-selected") &&
                    ((o = a), s.classList.remove("bfc-portshapebar-selected"));
            }
            if (e) {
                for (var s of i)
                ...
                for (a = 0; a < i.length; a++) {
                    s = i[a];
                    o == a && s.classList.add("bfc-portshapebar-selected");
                }
            }
        }
    }),
    (FlowChart.private.prototype.showPortShapeBar = function () {
        for (
            ...
            t[e].parentNode.removeChild(t[e]);
        var r = this.portShapeBarHTMLUI(this.selectedPort),
            i = document.createElement("div");
        i.classList.add("bfc-portshapebar"),
            i.setAttribute(
                "data-portsb-shape",
                `${this.selectedPort.shape.id}`
            ),
            i.setAttribute("data-portsb-port", `${this.selectedPort.id}`),
            (i.innerHTML = r),
            this.chart.element.appendChild(i);
        var o = this.chart.svgElement.querySelector(
            `[data-port-out-shape="${this.selectedPort.shape.id}"][data-port-out-port="${this.selectedPort.id}"]`
        ),
            a = this.chart.svgElement.querySelector(
        ...
        a.classList.add("bfc-ports-invisible"),
            o.classList.add("bfc-ports-visible");
        var l = o.getBoundingClientRect(),
            ...
            p = 0,
            u = parseFloat(
                window.getComputedStyle(i, null).getPropertyValue("padding-top")
            ),
            f = parseFloat(
                window
        ...
        (i.style.left = d + "px"),
            ...
            (i.style.transform = `rotate(${w}deg)`);
    }),
    (FlowChart.SelectedShapeCollection = class extends Array {
        _;
        constructor(t) {
            super(),
                (this._ = new FlowChart.SelectedShapeCollection.private(t));
        }
        get first() {
            return this.length ? this[0] : null;
        }
                ...
                for (var e = this.length - 1; e >= 0; e--)
                    if (t == this[e])
                        return (
                            this._.chart._.snap(),
                            this.splice(e, 1),
                            void this._.chart._.changed({
                                property: "selectedShapes",
                            })
                        );
        }
        clear() {
    ...
    (FlowChart.SelectedShapeCollection.private = class {
                ...
                if (a != i)
                    if (i.right - a.left <= 0)
                        if (null == o)
                            ...
                            (s = Math.hypot(a.y - i.y, a.left - i.right)) <
                                o.hypot && (o = { shape: a, hypot: s });
            }
            this.hideAndShowNext(o, e, r);
        }
        selectLeft(t, e, r) {
            var i = r[r.length - 1],
                o = null;
                ...
                if (a != i)
                    if (i.left - a.right >= 0)
                        if (null == o)
                            ...
                            (s = Math.hypot(a.y - i.y, a.right - i.left)) <
                                o.hypot && (o = { shape: a, hypot: s });
            }
            this.hideAndShowNext(o, e, r);
        }
                ...
                if (a != i)
                    if (i.top - a.bottom >= 0)
                        if (null == o)
                            ...
                            (s = Math.hypot(a.x - i.x, a.bottom - i.top)) <
                                o.hypot && (o = { shape: a, hypot: s });
            }
            this.hideAndShowNext(o, e, r);
        }
            ...
            for (var a of t) {
                ...
                if (i.bottom - a.top <= 0)
                    if (null == o)
                        ...
                        (s = Math.hypot(a.x - i.x, a.top - i.bottom)) <
                            o.hypot && (o = { shape: a, hypot: s });
            }
            this.hideAndShowNext(o, e, r);
        }
        hideAndShowNext(t, e, r) {
            if (t) {
                for (var i of (e && r.clear(), r))
                    -1 == this.arrayBeforeShiftPressed.indexOf(i) &&
                        (i.selected = !1);
                (t.shape.selected = !0), this.chart.makeShapeVisible(t.shape);
            }
        }
        update(t, e) {
            var r = this.chart.svgElement.querySelector(
                `[data-selector-shape-id="${t.id}"]`
            );
            if (r) {
                var i = FlowChart.shapeTemplates[t.templateId].offset(t),
                    o = t.left + i.x,
                    a = t.right + i.x,
                    s = t.top + i.y,
                    h = t.bottom + i.y,
                    ...
                    c = t.x + i.x,
                    d = t.y + i.y,
                    p = r.querySelector(".bfc-selector-rect");
                p.setAttribute("x", o),
                    p.setAttribute("y", s),
                ...
                for (var u = 1; u <= 2; u++) {
                    var f = r.querySelector(
                        `[data-selector-dot-${u}="topLeft"]`
                    );
                    f &&
                        (f.setAttribute("cx", o),
                            f.setAttribute("cy", s),
                            f.setAttribute("transform", `scale(${1 / e})`));
                    var w = r.querySelector(`[data-selector-dot-${u}="top"]`);
                    w &&
                        (w.setAttribute("cx", c),
                            w.setAttribute("cy", s),
                            w.setAttribute("transform", `scale(${1 / e})`));
                    var y = r.querySelector(
                        `[data-selector-dot-${u}="topRight"]`
                    );
                    y &&
                        (y.setAttribute("cx", a),
                            y.setAttribute("cy", s),
                            y.setAttribute("transform", `scale(${1 / e})`));
                    var m = r.querySelector(`[data-selector-dot-${u}="right"]`);
                    m &&
                        (m.setAttribute("cx", a),
                            m.setAttribute("cy", d),
                            m.setAttribute("transform", `scale(${1 / e})`));
                    var g = r.querySelector(
                        `[data-selector-dot-${u}="bottomRight"]`
                    );
                    g &&
                        (g.setAttribute("cx", a),
                            g.setAttribute("cy", h),
                    ...
                    var C = r.querySelector(
                        `[data-selector-dot-${u}="bottomLeft"]`
                    );
                    C &&
                        (C.setAttribute("cx", o),
                            C.setAttribute("cy", h),
                            C.setAttribute("transform", `scale(${1 / e})`));
                    var N = r.querySelector(`[data-selector-dot-${u}="left"]`);
                    N &&
                        (N.setAttribute("cx", o),
                            N.setAttribute("cy", d),
                            N.setAttribute("transform", `scale(${1 / e})`));
                }
            }
        }
        hideUI() {
        ...
        removeSelectorElement(t) {
            if (t) {
                (r = this.chart.svgElement.querySelector(
                    `[data-selector-shape-id="${t.id}"]`
                ...
                for (var r of e) r.parentNode.removeChild(r);
            }
        }
        ...
        html(t, e) {
            var r = 1 / e,
                i = FlowChart.shapeTemplates[t.templateId].offset(t),
                o = t.left + i.x,
                a = t.right + i.x,
                s = t.top + i.y,
                h = t.bottom + i.y,
                ...
                c = t.x + i.x,
                d = t.y + i.y,
                p = `<rect stroke-width="${t.strokeWidth}" class="bfc-selector-rect" x="${o}" y="${s}" width="${l}" height="${n}"></rect>`;
            return (
                t.resizable &&
                this.chart.selectedShapes.nodes.length > 0 &&
                (p += `<circle transform="scale(${r})" data-selector-dot-1="topLeft" cx="${o}" cy="${s}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="top"  cx="${c}" cy="${s}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="topRight"  cx="${a}" cy="${s}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="right"  cx="${a}" cy="${d}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="bottomRight"  cx="${a}" cy="${h}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="bottom"  cx="${c}" cy="${h}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="bottomLeft"  cx="${o}" cy="${h}" r="5"></circle>\n            <circle transform="scale(${r})" data-selector-dot-1="left"  cx="${o}" cy="${d}" r="5"></circle>                   \n            \n            <circle transform="scale(${r})" data-selector-dot-2="topLeft" cx="${o}" cy="${s}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="top"  cx="${c}" cy="${s}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="topRight"  cx="${a}" cy="${s}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="right"  cx="${a}" cy="${d}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="bottomRight"  cx="${a}" cy="${h}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="bottom"  cx="${c}" cy="${h}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="bottomLeft"  cx="${o}" cy="${h}" r="10"></circle>\n            <circle transform="scale(${r})" data-selector-dot-2="left" cx="${o}" cy="${d}" r="10"></circle>`),
                p
            );
        }
    }),
    ...
    (FlowChart.Editor.private = class {
        ...
        getFieldNames(t) {
            for (
                var e = [],
                r = t.element.querySelectorAll("[data-field]"),
                i = 0;
                i < r.length;
                i++
            ) {
                var o = r[i].getAttribute("data-field");
                e.push(o);
            }
            return e;
        }
        ...
        selectNextField() {
            for (
                var t = this.chart.svgElement.querySelector(
                    "[contenteditable]"
                ),
                e = t.parentNode;
            ...
            if (e && e.hasAttribute && e.hasAttribute("data-shape-id")) {
                var r = t.getAttribute("data-field"),
                    i = e.getAttribute("data-shape-id"),
                    o = this.chart.getShape(i),
                    a = this.getFieldNames(o),
                    s = a.indexOf(r);
                ++s >= a.length && (s = 0), this.edit(o, a[s]);
            }
        }
        clearFieldBorders() {
            for (
        ...
        edit(t, e) {
            t.element;
            for (
                var r = t.element.querySelectorAll("[data-field-selector]"),
                i = 0;
                i < r.length;
                i++
            )
                r[i].parentNode.removeChild(r[i]);
            var o = t.element.querySelectorAll("[data-field]");
            for (i = 0; i < o.length; i++) {
                var a = (g = o[i]).getAttribute("data-field"),
                    s = a;
                g.hasAttribute("data-title") &&
                    (s = g.getAttribute("data-title"));
                ...
                const r = e.matrixTransform(f);
                var w = document.createElementNS(
                    "http://www.w3.org/2000/svg",
                    "rect"
                );
                w.setAttribute("width", c / this.chart.scale),
                    w.setAttribute("height", d / this.chart.scale),
                    w.setAttribute("x", r.x),
                    w.setAttribute("y", r.y),
                    w.setAttribute("data-field-selector", a),
                    w.classList.add("bfc-field-border"),
                    (w.innerHTML = `<title>${s}</title>`),
                    t.element.appendChild(w);
            }
            if (e) {
                var y = this,
                    m = this.chart.svgElement.querySelectorAll(
                        "[contenteditable]"
                    );
                ...
                var g;
                (g = this.chart.svgElement.querySelector(
                    `[data-shape-id="${t.id}"] [data-field="${e}"]`
                )).setAttribute("contenteditable", "");
                var v = document.createRange();
                v.selectNodeContents(g);
                var C = window.getSelection();
                C.removeAllRanges(),
                    C.addRange(v),
                    g.focus(),
                    g.blurAdded ||
                    (g.addEventListener("blur", function (t) {
                        for (
                            var e = y.chart.svgElement.querySelector(
                                "[contenteditable]"
                            ),
                            r = e.getAttribute("data-field"),
                            i = e.innerHTML.trim(),
                            o = e;
                            !o.hasAttribute("data-shape-id");

                        )
                            o = o.parentNode;
                        var a = o.getAttribute("data-shape-id");
                        (y.chart.getShape(a)[r] = i),
    ...
    (FlowChart.private.prototype.reposition = function (t) {
        if (this.chart.nodes.length) {
            ...
            var e = this.svgBCR.width,
                r = this.svgBCR.height,
                i = e / 2,
                o = r / 2,
                a = this.chart.viewBox,
                s =
            ...
            switch (t) {
                case FlowChart.startPosition.center:
                    (a[0] =
                        ...
                        (a[1] =
                            this.chart.nodes.top +
                            (this.chart.nodes.bottom - this.chart.nodes.top) /
                            2 -
                            o / this.chart.scale),
                        (this.chart.viewBox = a);
                    break;
                case FlowChart.startPosition.centerTop:
                    var l = this.chart.nodes._.minShapeY;
                    (a[0] = l.x - i / this.chart.scale),
                        (a[1] = l.top - FlowChart.PADDING),
                        (this.chart.viewBox = a);
                    break;
                ...
                case FlowChart.startPosition.centerRight:
                    ...
                    (a[0] = l.left - FlowChart.PADDING),
                        (a[1] = l.y - o / this.chart.scale),
                        (this.chart.viewBox = a);
                    break;
                case FlowChart.startPosition.centerLeft:
                    l = this.chart.nodes._.maxShapeX;
                    (a[0] = l.right + FlowChart.PADDING - e / this.chart.scale),
                        (a[1] = l.y - o / this.chart.scale),
                        (this.chart.viewBox = a);
                    break;
    ...
    (FlowChart.private.prototype.makeShapesVisible = function (t, e) {
        ...
        var s = this.chart.viewBox,
            h = s.slice();
        (s[0] = Math.max(
            r.right + FlowChart.PADDING - i / this.chart.scale,
            s[0]
        )),
            (s[1] = Math.max(
                r.bottom + FlowChart.PADDING - o / this.chart.scale,
                s[1]
            )),
            (s[0] = Math.min(r.left - FlowChart.PADDING, s[0])),
            (s[1] = Math.min(r.top - FlowChart.PADDING, s[1])),
            h[0] != s[0] || h[1] != s[1]
    ...
    (FlowChart.private.prototype.animateShapes = function (t, e, r, i) {
    ...
    FlowChart.events.on("init", function (t) {
        t.menuBar._.undoReduRefresh(),
            t.menuBar._.colorMenuBarRefresh(),
        ...
        refreshHint() {
            if (this.useRefreshHint) {
                ...
                if (
                    -1 != t.indexOf("shape") &&
                    this.chart.selectedShapes.nodes.length ==
                    this.chart.nodes.length
                )
                    this.setContent("Press F to fit to page and center.");
                else if (-1 != t.indexOf("node")) {
                    for (
                        var e = this.chart.selectedShapes.last, r = [], i = 0;
                        i < this.chart.options.colors.length;
                        i++
                    ) {
                        var o = this.chart.options.colors[i];
                        e.fill != o && r.push(i + 1);
                    }
                    var a = "";
                    for (i = 0; i < r.length; i++)
                        0 == i
                            ...
                            : i == r.length - 1
                                ...
                                : (a += `, ${r[i]}`);
                    this.setContent(
                        `Press CTRL + Arrow to open port; Press Interval or Enter to edit; Press ${a} to change the color;`
                    );
                } else if (-1 != t.indexOf("label"))
                    this.setContent(
                        "Press Interval or Edit to edit the label;"
                    );
                else if (-1 != t.indexOf("field")) {
                    this.chart.selectedShapes.last;
                    this.setContent(
    ...
    (FlowChart.ShapeBar.private = class {
        ...
        init() {
            ...
            for (var e in FlowChart.shapeTemplates) {
                var r = FlowChart.shapeTemplates[e];
                if (r.displayInShapeBar) {
                    var i = { templateId: e };
                    (i.width = "fit" == r.width ? r.minWidth : r.width),
                        (i.height = "fit" == r.width ? r.minHeight : r.height),
                        (i.strokeWidth = r.strokeWidth),
                        (i.fill = r.fill);
                    var o = r.displayName;
                    t += `<div data-shapebar-item-id="${e}">\n                        <svg ${""} class="bfc-shapebar-svg ${i.templateId
                        }" viewBox="0 0 ${i.width} ${i.height
                        }" preserveAspectRatio="xMidYMid meet" >\n                            ${r.svg(
                            i
                        )}\n                        </svg>\n                        <div>${o}</div>              \n                    </div>`;
            ...
            if (null !== sessionStorage.getItem("shapebar-position")) {
                var a = JSON.parse(sessionStorage.getItem("shapebar-position"));
                `top:${a.top}px;left:${a.left}px;`;
            }
            this.getElement().innerHTML = `<div class="bfc-shapebar-move">\n                        <div class="bfc-shapebar-move-line"></div>\n                    </div>\n                    <div class="bfc-shapebar-shapes">\n                        ${t}  \n                    </div>  `;
        }
    }),
    ...
    (FlowChart.private.prototype.undoStepsCount = function () {
        ...
        for (
            var t = `${this.uid}_undo_`, e = Object.keys(sessionStorage), r = 0;
            -1 != e.indexOf(t + r);
    ...
    (FlowChart.private.prototype.redoStepsCount = function () {
        if (!this.chart.options.useSession) return 0;
        for (
            var t = `${this.uid}_redo_`, e = Object.keys(sessionStorage), r = 0;
            -1 != e.indexOf(t + r);
    ...
    (FlowChart.private.shadeColor = function (t, e) {
        ...
        return (
            ...
            (o = (o = parseInt((o * (100 + e)) / 100)) < 255 ? o : 255),
            (r = Math.round(r)),
            (i = Math.round(i)),
            (o = Math.round(o)),
            "#" +
    ...
    (FlowChart.private.mergeDeep = function (t, e) {
        if (FlowChart.private.isObject(t) && FlowChart.private.isObject(e))
            for (var r in e)
                FlowChart.private.isObject(e[r])
                    ? (t[r] || Object.assign(t, { [r]: {} }),
                        FlowChart.private.mergeDeep(t[r], e[r]))
    ...
    (FlowChart.private.rotate = function (t, e, r) {
        var i = (Math.PI / 180) * r,
            o = Math.cos(i),
            a = Math.sin(i);
        return {
            x: o * (e.x - t.x) + a * (e.y - t.y) + t.x,
            y: o * (e.y - t.y) - a * (e.x - t.x) + t.y,
        };
    }),
    (FlowChart.private.getScale = function (t, e, r) {
        var i = e / t[2],
            o = r / t[3];
        return i > o ? o : i;
    }),
    (FlowChart.private.pinchMiddlePointInPercent = function (t, e, r, i) {
    ...
    (FlowChart.private.roundPathCorners = function (t, e, r) {
        function i(t, e, r) {
            var i = e.x - t.x,
                a = e.y - t.y,
                s = Math.sqrt(i * i + a * a);
            return o(t, e, Math.min(1, r / s));
        }
        function o(t, e, r) {
            ...
            for (var f = 1; f < t.length; f++) {
                ...
                if (
                    ...
                    var g,
                        ...
                        x = s(m);
                    r
                        ? ((g = o(N, w.origPoint || C, e)),
                            (v = o(N, m.origPoint || x, e)))
                        : ((g = i(N, C, e)), (v = i(N, x, e))),
                        a(y, g),
                        (y.origPoint = N),
                        d.push(y);
                    var I = o(g, N, 0.5),
                        F = o(N, v, 0.5),
                        b = ["C", I.x, I.y, F.x, F.y, v.x, v.y];
                    (b.origPoint = N), d.push(b);
                } else d.push(y);
            }
            if (u) {
    ...
    (FlowChart.private.centerPointInPercent = function (t, e, r) {
        var i = t.getBoundingClientRect(),
            o = e - i.left,
            a = r - i.top;
        return [o / (i.width / 100), a / (i.height / 100)];
    }),
    ...
    (FlowChart.private.stickPosition = function (t, e, r) {
        var i = t.getBoundingClientRect(),
            ...
            h = i.top - o.top;
        return (
            i.top + a.height > o.top + o.height && (h -= a.height),
            i.left - a.width < o.left && (s += a.width),
            { x: s, y: h }
        );
    }),
    ...
    (FlowChart.private.getFirstPointIndexByMousePosition = function (t, e, r) {
        var i = e.createSVGPoint();
        (i.x = t.clientX),
            (i.y = t.clientY),
            (i = i.matrixTransform(e.getScreenCTM().inverse()));
        for (
            var o = Number.MAX_VALUE, a = 0, s = 0;
            s < r.points.length - 1;
            s++
        ) {
            var h = r.points[s],
                ...
                c = Math.hypot(i.x - h.x, i.y - h.y),
                d = Math.hypot(i.x - l.x, i.y - l.y);
            c + d - n < o && ((o = c + d - n), (a = s));
        }
        return a;
    }),
    (FlowChart.private.getLabelXY = function (t, e) {
        var r = (e.length / 100) * t.position,
            i = 0,
            o = 0,
            a = null == t.movex ? 0 : t.movex,
        ...
        (l = e.points[o]), (n = e.points[o + 1]);
        var d,
            p,
            u = FlowChart.direction.horizontal;
        return (
            e.points[o].x == e.points[o + 1].x &&
            (u = FlowChart.direction.vertical),
            u == FlowChart.direction.horizontal
                ? ((d = l.x < n.x ? l.x + (r - i) + a : l.x - (r - i) + a),
                    (p = l.y + s))
                : ((p = l.y < n.y ? l.y + (r - i) + s : l.y - (r - i) + s),
                    (d = l.x + a)),
            { x: d, y: p, direction: u }
        );
    }),
    ...
    (FlowChart.private.getFitScale = function (t, e, r, i, o, a, s) {
        var h = 1;
        if (r == FlowChart.startPosition.fit) {
            var l = t / a,
                n = e / s;
            h = l > n ? n : l;
        } else
            r == FlowChart.startPosition.fitWidth
                ? (h = t / a)
                : r == FlowChart.startPosition.fitHeight && (h = e / s);
        return h && h > i && (h = i), h && h < o && (h = o), h;
    }),
    (FlowChart.private.downloadFile = function (t, e, r, i, o) {
        ...
        if (1 == i) {
            ...
            if (void 0 !== h.download) {
                ...
                h.setAttribute("href", s);
                var l = r;
                l.toLowerCase().endsWith(o.toLowerCase()) || (l = l + "." + o),
    ...
    (FlowChart.private.findClosestPorts = function (t, e) {
        var r = Number.MAX_SAFE_INTEGER,
            i = null,
            o = FlowChart.shapeTemplates[t.templateId].ports(t),
            a = FlowChart.shapeTemplates[e.templateId].ports(e);
        for (var s in o) {
            var h = o[s];
            for (var l in a) {
                var n = a[l],
                ...
                c < r && ((r = c), (i = { fromPortName: s, toPortName: l }));
            }
        }
        return i;
    }),
    (FlowChart.private.rippleShape = function (t, e, r) {
        var i = t.height > t.width ? t.height : t.width;
        i /= 2;
        ...
        FlowChart.private.animate(
            ...
            FlowChart.anim.outPow,
            function () {
                t.element.removeChild(o), r && r();
            }
        );
    }),
    (FlowChart.private.getLayer = function (t, e) {
        if (!(r = t.querySelector(`[data-layer="${e}"]`))) {
            var r;
            ...
            for (
                var i = t.querySelectorAll("[data-layer]"), o = [], a = 0;
                a < i.length;
                a++
            )
                o.push(parseFloat(i[a].getAttribute("data-layer")));
            o.push(e),
                o.sort(function (t, e) {
                    return t - e;
                });
            var s = o.indexOf(e),
                h = t.querySelector(`[data-layer="${o[s + 1]}"]`);
            null == h ? t.appendChild(r) : h.parentNode.insertBefore(r, h);
        }
    ...
    (FlowChart.private.devin = function (t, e) {
        (t.v = "1.00.71"),
            FlowChart.remote.findRegion(function (r) {
                fetch(r, {
                    method: "POST",
    ...
    (FlowChart.remote.findRegion = function (t) {
        ...
        if (e) t(e);
            ...
            for (var i of [
                ...
                // fetch(`https://${i}.azurewebsites.net/api/FlowChartJS`, {
                //     method: "GET",
                //     signal: o.signal,
                // })
                //     .then(function (e) {
                //         for (var i of r) i.abort("cancel_request");
                //         localStorage.setItem("func-url-flowchartjs", e.url),
                //             t(e.url);
                //     })
                //     .catch(function (t) {
    ...
    (FlowChart.private.logo = function (t) {
        return (
            t ||
           /* '<svg onclick="alert(hi)" style="position: absolute; bottom: 8px; right: 7px; font-family: Verdana;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="160" height="27">      \n            <text fill="#039be5" style="font-size: 14px;font-weight:bold;" x="0" y="24">BALKAN</text>\n            <text fill="#f57c00" style="font-size: 14px;" x="70" y="24">FlowChart JS</text>\n        </svg>'*/
        );
    });
